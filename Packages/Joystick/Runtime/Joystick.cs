...
namespace zFrame.UI
{
    public class Joystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
    {
        ...
        [SerializeField]
        bool dynamic = true; // 是否为动态摇杆

        [SerializeField]
        bool showDirectionArrow = true; // 是否展示指向器
...
#region Property
        public bool IsDraging {
            get { return fingerId != int.MinValue && isMoving; }
        } //摇杆拖拽状态
...
#region MonoBehaviour functions
        ...
        void Update() =>
            OnValueChanged.Invoke(knob.localPosition
                / maxRadius); //fixedupdate 为物理更新，摇杆操作放在常规 update 就好
        ...
        void IDragHandler.OnDrag(PointerEventData eventData)
        {
            ...
            Vector2 localPosition = new Vector2() {
                x = (activatedAxis == Direction.Both || activatedAxis == Direction.Horizontal)
                    ? (direction.normalized * radius).x : 0, //确认是否激活水平轴向
                y = (activatedAxis == Direction.Both || activatedAxis == Direction.Vertical)
                    ? (direction.normalized * radius).y : 0 //确认是否激活垂直轴向，激活就搞事情
            };
            ...
            if (showDirectionArrow) {
                ...
                arrow.localEulerAngles =
                    new Vector3(0, 0, Vector2.SignedAngle(Vector2.right, localPosition));
            }
            OnDragging.Invoke();
        }
...
#region Assistant functions / fields / structures
        ...
        public Transform knob; //摇杆

        [SerializeField, HideInInspector]
        public Transform backGround; //背景

        [SerializeField, HideInInspector]
        public Transform arrow; //指向器
        ...
        public enum Direction { Both, Horizontal, Vertical }
#endregion
    }
}
