...
//            ilfix.StartInfo.FileName = "../Bin/Hotfix.exe";
//            ilfix.StartInfo.Arguments = "../Lib/Hotfix.TestDLL.dll ../Data/ ../Lib/Hotfix.Core.dll";
...
//            using (FileStream fs = File.Open("../Data/Hotfix.TestDLL.Redirect.dif", FileMode.Open))
//            {
...
//        {
//            /*var virtualMachine = FileVirtualMachineBuilder.CreateVirtualMachine("../Data/Hotfix.TestDLL.dif");
//            for (int i = 0; i < 10; i++)
//            {
//                Call call = Call.Begin();
//                call.PushInteger(i);
