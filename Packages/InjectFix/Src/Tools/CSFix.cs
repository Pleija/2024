...
namespace Hotfix
{
    public static class Program
    {
        static void usage()
        {
            ...
            Console.WriteLine("Hotfix -inject core_assmbly_path assmbly_path config_path patch_file_output_path"
                + " injected_assmbly_output_path [search_path1, search_path2 ...]");
            Console.WriteLine("Hotfix -inherit_inject core_assmbly_path assmbly_path config_path "
                + "patch_file_output_path injected_assmbly_output_path inherit_assmbly_path "
                + "[search_path1, search_path2 ...]");
            Console.WriteLine("Hotfix -patch core_assmbly_path assmbly_path injected_assmbly_path"
