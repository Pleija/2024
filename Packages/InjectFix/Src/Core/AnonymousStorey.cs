...
namespace Hotfix.Core
{
    ...
    public class AnonymousStorey
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            callInfo.PushObject(this);
            callInfo.PushObject(obj);
            virtualMachine.Execute(equalMethodId, ref callInfo, 2, 0);
            return callInfo.GetBoolean(0);
        }
        ...
        public override int GetHashCode()
        {
            ...
            CallInfo callInfo = CallInfo.Begin();
            callInfo.PushObject(this);
            virtualMachine.Execute(getHashCodeMethodId, ref callInfo, 1, 0);
            return callInfo.GetInt32(0);
        }
        ...
        public override string ToString()
        {
            ...
            CallInfo callInfo = CallInfo.Begin();
            callInfo.PushObject(this);
            virtualMachine.Execute(toStringMethodId, ref callInfo, 1, 0);
            return callInfo.GetAsType<string>(0);
        }
        ...
        ~AnonymousStorey()
        {
            if (finalizeMethodId != -1)
            {
                CallInfo callInfo = CallInfo.Begin();
                callInfo.PushObject(this);
                virtualMachine.Execute(finalizeMethodId, ref callInfo, 1, 0);
            }
        }
    }
