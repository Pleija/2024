...
namespace Hotfix.Core
{
    ...
    public delegate void ExternInvoker(VirtualMachine vm, ref CallInfo callInfo, bool isInstantiate);
    ...
    public class NewFieldInfo
    {
        ...
        public unsafe void CheckInit(VirtualMachine virtualMachine, object obj)
        {
            ...
            {
                CallInfo callInfo = CallInfo.BeginForStack(stack);
                virtualMachine.Execute(MethodId, ref callInfo, 0, 0);
                SetValue(obj, callInfo.GetObject());
            }
        }
    ...
    unsafe public class VirtualMachine
    {
        ...
        //[Il2CppSetOption(Option.ArrayBoundsChecks, false)]
        //[Il2CppSetOption(Option.DivideByZeroChecks, false)]
        public void Execute(int methodIndex, ref CallInfo callInfo, int argsCount, int refCount = 0)
        {
            Execute(unmanagedCodes[methodIndex], callInfo.argumentBase + refCount, callInfo.managedStack,
                callInfo.evaluationStackBase, argsCount, methodIndex, refCount, callInfo.topWriteBack);
        }
            ...
            while (true) //TODO: 常用指令应该放前面
            {
                try
                {
                    ...
                    switch (code)
                    {
                        ...
                        case Code.Newobj: // 2.334642%
                            ...
                            externInvokeFunc(this, ref callInfo, code == Code.Newobj);
                            evaluationStackPointer = callInfo.currentTop;
                            break;
                ...
                catch(Exception e)
                {
                    ...
                    else
                    {
                        ...
                        throwExcepton = null;
                        Debug.Log($"method Index: {methodIndex}");
                        throw e;
                    }
                }
            }
