...
namespace Hotfix.Core
{
    ...
    unsafe public struct CallInfo
    {
        ...
        internal static CallInfo BeginForStack(ThreadStackInfo stack)
        {
            return new CallInfo()
            {
                managedStack = stack.ManagedStack,
        ...
        public static void End(ref CallInfo callInfo)
        {
            //Top的维护
