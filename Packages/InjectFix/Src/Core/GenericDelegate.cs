...
namespace Hotfix.Core
{
    ...
    internal class GenericDelegate
    {
        ...
        public void Action()
        {
            CallInfo callInfo = CallInfo.Begin();
            if (pushSelf)
            {
                callInfo.PushObject(anonObj);
            }
            virtualMachine.Execute(methodId, ref callInfo, extraArgNum);
        }
            ...
            where T1 : class
        {
            ...
            //push第一个参数
            callInfo.PushObject(p1);
            //调用指定id的虚拟机方法
            virtualMachine.Execute(methodId, ref callInfo, 1 + extraArgNum);
        }
            ...
            where T2 : class
        {
            ...
            callInfo.PushObject(p1);
            callInfo.PushObject(p2);
            virtualMachine.Execute(methodId, ref callInfo, 2 + extraArgNum);
        }
            ...
            where T3 : class
        {
            ...
            callInfo.PushObject(p1);
            callInfo.PushObject(p2);
            callInfo.PushObject(p3);
            virtualMachine.Execute(methodId, ref callInfo, 3 + extraArgNum);
        }
            ...
            where T4 : class
        {
            ...
            callInfo.PushObject(p2);
            callInfo.PushObject(p3);
            callInfo.PushObject(p4);
            virtualMachine.Execute(methodId, ref callInfo, 4 + extraArgNum);
        }
            ...
            where TResult : class
        {
            ...
            virtualMachine.Execute(methodId, ref callInfo, extraArgNum);
            return (TResult)callInfo.GetObject();
        }
