@set UNITY_HOME=E:\UnityEditor\2019.4.40f1c1
...
@set DLL_OUTPUT=..\Runtime\Plugins\Hotfix.Core.dll
@set TOOL_KIT_PATH=..\Tools~
...
call %GMCS% -define:UNITY_IPHONE -unsafe -reference:ThirdParty\Mono.Cecil.dll,ThirdParty\Mono.Cecil.Mdb.dll,ThirdParty\Mono.Cecil.Pdb.dll -out:%TOOL_KIT_PATH%\Hotfix.exe -debug Instruction.cs Src\Tools\*.cs Src\Version.cs
pause
