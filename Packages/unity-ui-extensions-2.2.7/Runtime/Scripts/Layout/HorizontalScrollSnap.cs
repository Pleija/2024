...
namespace UnityEngine.UI.Extensions
{
    ...
    public class HorizontalScrollSnap : ScrollSnapBase
    {
        ...
        [FormerlySerializedAs("m_StopManualChangePage")]
        [SerializeField, HideInInspector]
        bool stopDragPage;

        //[ShowInInspector]
        public bool StopDragPage {
            get => stopDragPage;
            set {
                stopDragPage = value;
                ...
                {
                     GetComponent<ScrollRect>().horizontal = !StopDragPage;
                }
        ...
        void Update()
        {
            ...
            {
                _screensContainer.anchoredPosition = Vector3.Lerp(_screensContainer.anchoredPosition,
                    _lerp_target, transitionSpeed * (UseTimeScale ? Time.deltaTime : Time.unscaledDeltaTime));
        ...
        {
            return (_scroll_rect.velocity.x > startingSpeed &&
                    _scroll_rect.velocity.x < SwipeVelocityThreshold) ||
                   (_scroll_rect.velocity.x < startingSpeed &&
                    _scroll_rect.velocity.x > -SwipeVelocityThreshold);
        }
        ...
        public void DistributePages()
        {
            ...
            {
                RectTransform child = _screensContainer.transform.GetChild(i)
        ...
        private void OnEnable()
        {
            ...
            if (Application.isPlaying)
            {
                ...
                if (EnableDrag)
                {
                    EnableDrag.onValueChanged.AddListener(x => StopDragPage = !x);
                    StopDragPage = !EnableDrag.isOn;
                }
            }
        ...
        public override void OnEndDrag(PointerEventData eventData)
        {
            ...
            if (_scroll_rect.horizontal)
            {
                ...
                else
                {
                    ...
                    {
                        if (UseFastSwipe &&
                            distance < panelDimensions.width &&
                            distance >= FastSwipeThreshold)
                        {
                            _scroll_rect.velocity = Vector3.zero;
