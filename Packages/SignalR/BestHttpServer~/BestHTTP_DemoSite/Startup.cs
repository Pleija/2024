    ...
    public class Startup
    {
        private readonly SymmetricSecurityKey SecurityKey =
            new SymmetricSecurityKey(
                System.Text.Encoding.ASCII.GetBytes("Super secret security key!"));
                ...
                options.Events = new JwtBearerEvents {
                    OnMessageReceived = context => {
                        ...
                        if(!string.IsNullOrEmpty(accessToken) &&
                           (path.StartsWithSegments("/HubWithAuthorization"))) {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseCors(builder => {
                builder.WithOrigins("*", "https://localhost:5001", "https://dev.pleija.com:5001",
                        "http://dev.pleija.com:5000", "http://localhost:5000",
                        "https://localhost:4000",
                        "https://besthttpdemosite.azurewebsites.net",
                        "https://besthttpdemo.azureedge.net",
                        "https://besthttpwebgldemo.azurewebsites.net",
                        "https://benedicht.github.io")
            ...
            option.OnPrepareResponse += content => {
                ...
                content.Context.Response.Headers[
            ...
            app.Run(async (context) => {
                if(context.Request.Path.StartsWithSegments("/generateJwtToken")) {
                    ...
                    if(redirectCount != StringValues.Empty &&
                       int.TryParse(redirectCount[0], out int count) && count >= 5)
                        path = "redirect";
                    await context.Response.WriteAsync(JsonConvert.SerializeObject(new {
        ...
        private string GenerateJwtToken()
        {
            ...
            var token = new JwtSecurityToken("BestHTTP Demo Site", "BestHTTP Demo Site Users",
                claims, expires: DateTime.Now.AddHours(15), signingCredentials: credentials);
