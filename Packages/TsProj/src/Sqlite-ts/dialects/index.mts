import { KeyVal, ResultSet, TableInfo, ValueOf } from '../types.mjs'
import { Utils } from '../utils.mjs'
import { DialectBase, DialectKind, IDialectBase } from './base/index.mjs'
import { IDialectWhere, ReadDialect } from './base/read.mjs'
...
export class Dialect<T, TDb> extends DialectBase<T, any> {
    ...
    insert(set: Partial<T> | Array<Partial<T>>,
           upsert?: boolean
