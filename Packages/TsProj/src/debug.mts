...
import DateTimeOffset = CS.System.DateTimeOffset;
...
export const checkType = function (...args: any[]) {
    const timeStamp =  DateTimeOffset.UtcNow.ToUnixTimeSeconds();
    console.log(timeStamp, typeof  timeStamp);
    UnityApi.CheckType("test", 1, 1.0, {key: "Test", value: false}, [0, 1], null, false);
}
