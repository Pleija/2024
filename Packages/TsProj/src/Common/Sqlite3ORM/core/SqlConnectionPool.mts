...
import { SQL_OPEN_CREATE, SQL_OPEN_DEFAULT, SqlDatabase } from './SqlDatabase.mjs';
import { SqlDatabaseSettings } from './SqlDatabaseSettings.mjs';
...
export class SqlConnectionPool {
  ...
  async open(
    databaseFile: string,
    mode: number|string = SQL_OPEN_DEFAULT,
    min: number = 1,
    max: number = 0,
