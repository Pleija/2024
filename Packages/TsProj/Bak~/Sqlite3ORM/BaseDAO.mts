...
import { SqlDatabase } from './core/index.mjs';
import { MetaModel, Table } from './metadata/index.mjs';
import { Filter, isFilter, QueryModel, TABLEALIAS, Where } from './query/index.mjs';
...
export class BaseDAO<T extends Object> {
  ...
  protected toFilter(whereOrFilter?: Where<T> | Filter<T> | any, tableAlias?: string): Filter<T> {
