...
public static class ApplyPlatformDefines
{
    ...
    public static string[] Paths = { "Assets/Plugins/SignalR" };

    [MenuItem("Tools/Apply SignalR Constraints")]
    ...
    private static void Execute()
    {
        ...
        foreach (var guid in assets) {
            ...
            if (pluginImporter is null) continue;
            ...
            constraints.RemoveAll(x => x.Equals(NetStandard, StringComparison.OrdinalIgnoreCase)
