...
namespace UniRx
{
        ...
        IObserverLinkedList<T>
    {
        ...
        protected virtual void SetValue(T aValue)
        {
            value = OnSet != null ? OnSet(aValue) : aValue;
        }

        public void SetValueAndForceNotify(T aValue)
        {
            SetValue(aValue);
            if (isDisposed)
                return;
