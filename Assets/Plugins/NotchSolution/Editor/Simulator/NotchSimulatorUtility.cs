 ...
 T.GetMethod("GetMainGameViewTargetSizeNoBox", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static);
        ...
        internal static string DevicesFolder
        {
            get
            {
                ...
                {
                    devicesFolderCached = AssetDatabase.GUIDToAssetPath("6abeb91eac589451a823e759aff57aad");
                    if (string.IsNullOrEmpty(devicesFolderCached))
                    {
                        devicesFolderCached = "Packages/NotchSolution/Editor/Devices";

                        if (!Directory.Exists(devicesFolderCached)) {
                            devicesFolderCached = "Assets/Plugins/NotchSolution/Editor/Devices";
                        }
                    }
                }
