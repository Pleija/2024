...
namespace FormatWith.Internal
{
    ...
    {
        public static void AppendWithEscapedBrackets(this StringBuilder stringBuilder, string value,
            int startIndex, int count, char openBraceChar = '{', char closeBraceChar = '}')
        {
