...
#pragma warning disable CS0618
            if (serializedValue?.value !=
                null) // old serialization system can't serialize null values
            {
                value = serializedValue.value;
                Debug.Log("Migrated: " + serializedValue.value + " | " +
...
#pragma warning restore CS0618
        ...
        private static Dictionary<Type, Type> exposedParameterTypeCache =
...
#pragma warning restore CS0618
            if (oldType == null ||
                !exposedParameterTypeCache.TryGetValue(oldType, out var newParamType))
                return null;
        ...
        {
            if (ReferenceEquals(param1, null) && ReferenceEquals(param2, null)) return true;
            if (ReferenceEquals(param1, param2)) return true;
            if (ReferenceEquals(param1, null)) return false;
            if (ReferenceEquals(param2, null)) return false;
    ...
    {
        public enum FloatMode { Default, Slider }
        ...
        public class FloatSettings : Settings
        {
            ...
            public override bool Equals(Settings param) => base.Equals(param) &&
                mode == ((FloatSettings)param).mode && min == ((FloatSettings)param).min &&
    ...
    {
        public enum Vector2Mode { Default, MinMaxSlider }
        ...
        public class Vector2Settings : Settings
        {
            ...
            public override bool Equals(Settings param) => base.Equals(param) &&
                mode == ((Vector2Settings)param).mode && min == ((Vector2Settings)param).min &&
    ...
    {
        public enum IntMode { Default, Slider }
        ...
        public class IntSettings : Settings
        {
            ...
            public override bool Equals(Settings param) => base.Equals(param) &&
                mode == ((IntSettings)param).mode && min == ((IntSettings)param).min &&
    ...
    {
        public enum GradientColorMode { Default, HDR }
        ...
        [SerializeField]
        private Gradient val;

        [SerializeField, GradientUsage(true)]
        private Gradient hdrVal;
