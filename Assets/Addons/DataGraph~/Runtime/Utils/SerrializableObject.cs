    ...
    public class SerializableObject
    {
        ...
        public void Deserialize()
        {
            ...
            if (type.IsPrimitive) {
                ...
                value = serializedValue.Length > 1 ? serializedValue
                    .Substring(1, serializedValue.Length - 2).Replace("\\\"", "\"") : "";
            }
            else {
                try {
                    value = Activator.CreateInstance(type);
        ...
        public void Serialize()
        {
            ...
            {
                if (value as UnityEngine.Object == null) return;
                ...
                try {
                    ...
                    if (string.IsNullOrEmpty(serializedValue)) throw new Exception();
                }
                catch {
                    Debug.LogError("Can't serialize type " + serializedType);
                }
