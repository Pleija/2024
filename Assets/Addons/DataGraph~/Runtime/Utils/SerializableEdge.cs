...
namespace GraphProcessor
{
    ...
    public class SerializableEdge : ISerializationCallbackReceiver
    {
        ...
        public static SerializableEdge CreateNewEdge(BaseGraph graph, NodePort inputPort,
            NodePort outputPort)
        {
        ...
        {
            if (!owner.nodesPerGUID.ContainsKey(outputNodeGUID) ||
                !owner.nodesPerGUID.ContainsKey(inputNodeGUID))
                return;
