...
namespace Nodes.Examples.DefaultNodes.Nodes
{
    ...
    public class ForLoopNode : ConditionalNode
    {
        ...
        protected override void Process() =>
            index++; // Implement all logic that affects the loop inner fields

        public override IEnumerable<ConditionalNode> GetExecutedNodes() =>
            throw new System.Exception(
                "Do not use GetExecutedNoes in for loop to get it's dependencies");

        public IEnumerable<ConditionalNode> GetExecutedNodesLoopBody()
        {
            // Return all the nodes connected to the executes port
            return outputPorts.FirstOrDefault(n => n.fieldName == nameof(loopBody)).GetEdges()
        ...
        {
            // Return all the nodes connected to the executes port
            return outputPorts.FirstOrDefault(n => n.fieldName == nameof(loopCompleted)).GetEdges()
                .Select(e => e.inputNode as ConditionalNode);
        }
    }
}
