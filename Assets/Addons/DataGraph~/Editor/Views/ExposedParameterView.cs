...
namespace GraphProcessor
{
    public class ExposedParameterView : PinnedElementView
    {
        ...
        private readonly string exposedParameterViewStyle =
            "GraphProcessorStyles/ExposedParameterView";
        ...
        private int GetInsertIndexFromMousePosition(Vector2 pos)
        {
            ...
            foreach (var layout in blackboardLayouts) {
                if (mousePos > layout.yMin && mousePos < layout.yMax) return index + 1;
                index++;
            }
        ...
        private void OnDragUpdatedEvent(DragUpdatedEvent evt)
        {
            ...
            if (graphSelectionDragData == null) return;
        ...
        private void OnDragPerformEvent(DragPerformEvent evt)
        {
            ...
            foreach (var obj in DragAndDrop.GetGenericData("DragSelection") as List<ISelectable>)
                if (obj is ExposedParameterFieldView view) {
                    if (!updateList) graphView.RegisterCompleteObjectUndo("Moved parameters");
                    var oldIndex =
                        graphView.graph.exposedParameters.FindIndex(e => e == view.parameter);
