...
namespace GraphProcessor
{
    public class ExposedParameterFieldView : BlackboardField
    {
        ...
        public ExposedParameterFieldView(BaseGraphView graphView, ExposedParameter param) : base(
            null, param.name, param.shortType)
        {
        ...
        private void BuildContextualMenu(ContextualMenuPopulateEvent evt)
        {
            ...
            evt.menu.AppendAction("Delete",
                (a) => graphView.graph.RemoveExposedParameter(parameter),
                DropdownMenuAction.AlwaysEnabled);
            evt.StopPropagation();
        }
    }
