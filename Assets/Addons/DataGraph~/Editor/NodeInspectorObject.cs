...
{
    /// <summary>
    ///     Custom editor of the node inspector, you can inherit from this class to customize your node
    ///     inspector.
    /// </summary>
    ...
    public class NodeInspectorObjectEditor : Editor
    {
        ...
        protected virtual void OnEnable()
        {
            ...
            selectedNodeList.styleSheets.Add(
                Resources.Load<StyleSheet>("GraphProcessorStyles/InspectorView"));
        ...
        protected virtual void UpdateNodeInspectorList()
        {
            ...
            if (inspector.selectedNodes.Count == 0) selectedNodeList.Add(placeholder);
    ...
    public class NodeInspectorObject : ScriptableObject
    {
        ...
        public HashSet<BaseNodeView> selectedNodes { get; private set; } =
            new HashSet<BaseNodeView>();
