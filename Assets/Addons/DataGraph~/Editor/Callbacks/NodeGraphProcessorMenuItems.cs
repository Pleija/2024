...
{
    /// <summary>
    ///     To add the menu items that create node C# script templates files you can inherit from this
    ///     class and use it's API combined with [MenuItem]
    ...
    public class NodeGraphProcessorMenuItems
    {
        ...
        private static string _nodeTemplatePath = null;
