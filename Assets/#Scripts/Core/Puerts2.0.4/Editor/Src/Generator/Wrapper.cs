                ...
                public static StaticWrapperInfo FromType(Type type, List<Type> genTypes)
                {
                    ...
                    if (type.IsGenericType) {
                        ...
                        if (genericArguments.Where((t, index) => !t.IsPrimitive && t != typeof(System.String) && t != typeof(DateTime)).Count() > 0) {
                            ...
                            type = definitionType.MakeGenericType(definitionGenericArguments.Select((dType, index) => {
                            ...
                            GenericArgumentsInfos = definitionGenericArguments.Select((ga, index) => {
                                ...
                                GenericParameterAttributes constraints = ga.GenericParameterAttributes & GenericParameterAttributes.SpecialConstraintMask;
