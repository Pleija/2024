...
*/
    ...
    // }
    public static IEnumerable<object> AsWhere(this IEnumerable<object> data, Func<object, bool> cb) => data.Where(cb);
    ...
    public static IEnumerable<object> AsForEach(this IEnumerable<object> data, Action<object> cb) => data.ForEach(cb);
