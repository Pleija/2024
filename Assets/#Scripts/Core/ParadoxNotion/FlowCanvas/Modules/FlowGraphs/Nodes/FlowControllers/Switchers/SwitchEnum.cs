...
namespace FlowCanvas.Nodes
{
    ...
    public class SwitchEnum : FlowControlNode
    {
        ...
        {
            if (type == null) type = typeof(System.Enum);
        ...
        public override System.Type GetNodeWildDefinitionType() => typeof(System.Enum);
        ...
        protected override void OnNodeInspectorGUI()
        {
            ...
            if (GUILayout.Button("Select Enum Type"))
                EditorUtils.ShowPreferedTypesSelectionMenu(typeof(System.Enum), (t) => {
                    type = t;
                    GatherPorts();
                });
        }
