...
namespace FlowCanvas.Nodes
{
    ...
    public abstract class RouterEventNode<T> : EventNode where T : Component
    {
        ...
        protected abstract void Subscribe(ParadoxNotion.Services.EventRouter router);

        ///<summary>Called per target object with argument being the EventRouter of that object (never null)</summary>
        protected abstract void UnSubscribe(ParadoxNotion.Services.EventRouter router);
