...
{
    [Name("Particle Collision 2D"), Category("Events/Object")
    ...
    public class ParticleCollision2DEvents : RouterEventNode<Collider2D>
    {
        ...
        protected override void RegisterPorts()
        {
            ...
            AddValueOutput<ParticleSystem>("Particle System", () => {
                return particle;
            });
            AddValueOutput<Vector3>("Collision Point", () => {
                return collisionEvents[0].intersection;
            });
            AddValueOutput<Vector3>("Collision Normal", () => {
                return collisionEvents[0].normal;
            });
            AddValueOutput<Vector3>("Collision Velocity", () => {
        ...
        private void OnParticleCollision(ParadoxNotion.EventData<GameObject> msg)
        {
