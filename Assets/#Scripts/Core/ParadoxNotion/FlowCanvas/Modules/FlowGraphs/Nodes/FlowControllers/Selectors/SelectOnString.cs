...
{
    [ExposeAsDefinition, ContextDefinedInputs(typeof(Wild), typeof(string)), ContextDefinedOutputs(typeof(Wild))
     , Category("Flow Controllers/Selectors")
     , Description("Select a Result value out of the input cases provided, based on a String"), HasRefreshButton]
