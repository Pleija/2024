...
namespace FlowCanvas.Nodes
{
    ...
    public class CollisionEvents_Rigidbody : RouterEventNode<Rigidbody>
    {
        ...
        protected override void RegisterPorts()
        {
            ...
            AddValueOutput<Rigidbody>("Receiver", () => {
                return receiver;
            });
            AddValueOutput<GameObject>("Other", () => {
                return collision.gameObject;
            });
            AddValueOutput<ContactPoint>("Contact Point", () => {
                return collision.contacts[0];
            });
            AddValueOutput<Collision>("Collision Info", () => {
                return collision;
            });
        }
        ...
        private void OnCollisionEnter(ParadoxNotion.EventData<Collision> msg)
        {
        ...
        private void OnCollisionStay(ParadoxNotion.EventData<Collision> msg)
        {
            receiver = ResolveReceiver(msg.receiver);
            collision = msg.value;
        ...
        private void OnCollisionExit(ParadoxNotion.EventData<Collision> msg)
        {
            receiver = ResolveReceiver(msg.receiver);
            collision = msg.value;
