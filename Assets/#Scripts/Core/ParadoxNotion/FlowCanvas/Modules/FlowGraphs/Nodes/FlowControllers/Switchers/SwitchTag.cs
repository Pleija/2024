...
{
    [Category("Flow Controllers/Switchers"), Description("Branch the Flow based on the tag of a GameObject value")
     , ContextDefinedInputs(typeof(GameObject)), HasRefreshButton]
    public class SwitchTag : FlowControlNode
    {
        ...
        protected override void RegisterPorts()
        {
            ...
            for (var i = 0; i < cases.Length; i++) cases[i] = AddFlowOutput(_tagNames[i], i.ToString());
            AddFlowInput("In", (f) => {
