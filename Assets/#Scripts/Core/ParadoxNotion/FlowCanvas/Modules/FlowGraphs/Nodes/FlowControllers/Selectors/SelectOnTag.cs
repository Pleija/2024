...
{
    [ExposeAsDefinition, ContextDefinedInputs(typeof(Wild), typeof(GameObject)), ContextDefinedOutputs(typeof(Wild))
    ...
    public class SelectOnTag<T> : FlowControlNode
    {
        ...
        protected override void RegisterPorts()
        {
            ...
            for (var i = 0; i < cases.Length; i++) cases[i] = AddValueInput<T>("Is " + _tagNames[i], i.ToString());
