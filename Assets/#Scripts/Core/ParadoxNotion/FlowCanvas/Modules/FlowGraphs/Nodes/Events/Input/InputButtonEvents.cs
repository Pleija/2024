...
namespace FlowCanvas.Nodes
{
    ...
    public class InputButtonEvents : EventNode, IUpdatable
    {
        ...
        public override string name => string.Format("{0} [{1}]", base.name, buttonName);
        ...
        public void Update()
        {
            ...
            if (Input.GetButtonDown(value)) down.Call(new Flow());
            if (Input.GetButton(value)) pressed.Call(new Flow());
            if (Input.GetButtonUp(value)) up.Call(new Flow());
        }
    }
}
