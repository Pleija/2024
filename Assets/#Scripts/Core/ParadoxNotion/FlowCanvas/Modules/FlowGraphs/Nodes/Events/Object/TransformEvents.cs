...
namespace FlowCanvas.Nodes
{
    ...
    public class TransformEvents : RouterEventNode<Transform>
    {
        ...
        protected override void RegisterPorts()
        {
            ...
            AddValueOutput<Transform>("Parent", () => {
                return parent;
            });
            AddValueOutput<IEnumerable<Transform>>("Children", () => {
                return children;
            });
        }
        ...
        private void OnTransformParentChanged(ParadoxNotion.EventData msg)
        {
        ...
        private void OnTransformChildrenChanged(ParadoxNotion.EventData msg)
        {
            receiver = ResolveReceiver(msg.receiver);
            parent = receiver.parent;
            children = receiver.Cast<Transform>();
