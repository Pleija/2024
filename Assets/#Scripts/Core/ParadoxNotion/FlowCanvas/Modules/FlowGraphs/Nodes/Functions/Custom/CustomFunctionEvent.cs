...
namespace FlowCanvas.Nodes
{
    [Name("New Custom Function", 10)
     ...
     , Category("Functions/Custom"), ParadoxNotion.Serialization.DeserializeFrom("FlowCanvas.Nodes.RelayFlowOutput")]
    public class CustomFunctionEvent : EventNode, IInvokable, IEditorMenuCallbackReceiver
    {
        ...
        //shortcut
        private System.Type returnType => returns.type;
        ...
        private void AddParameter(System.Type type)
        {
        ...
        protected override void OnNodeInspectorGUI()
        {
            ...
            EditorUtils.ReorderableList(parameters, options, (i, r) => {
                ...
                parameter.name = UnityEditor.EditorGUILayout.DelayedTextField(parameter.name, GUILayout.Width(150)
            ...
            if (UnityEditor.EditorGUI.EndChangeCheck()) GatherPortsUpdateRefs();
        }
