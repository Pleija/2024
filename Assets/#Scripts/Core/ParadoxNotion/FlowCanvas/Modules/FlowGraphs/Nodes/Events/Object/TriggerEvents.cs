...
namespace FlowCanvas.Nodes
{
    ...
    public class TriggerEvents_Transform : RouterEventNode<Transform>
    {
        ...
        private void OnTriggerEnter(ParadoxNotion.EventData<Collider> msg)
        {
        ...
        private void OnTriggerStay(ParadoxNotion.EventData<Collider> msg)
        {
            receiver = ResolveReceiver(msg.receiver);
            other = msg.value.gameObject;
        ...
        private void OnTriggerExit(ParadoxNotion.EventData<Collider> msg)
        {
            receiver = ResolveReceiver(msg.receiver);
            other = msg.value.gameObject;
