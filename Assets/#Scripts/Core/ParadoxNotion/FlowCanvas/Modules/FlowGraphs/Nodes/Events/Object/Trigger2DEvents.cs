...
namespace FlowCanvas.Nodes
{
    ...
    public class Trigger2DEvents_Transform : RouterEventNode<Transform>
    {
        ...
        protected override void RegisterPorts()
        {
            ...
            AddValueOutput<Transform>("Receiver", () => {
                return receiver;
            });
        ...
        private void OnTriggerEnter2D(ParadoxNotion.EventData<Collider2D> msg)
        {
        ...
        private void OnTriggerStay2D(ParadoxNotion.EventData<Collider2D> msg)
        {
            receiver = ResolveReceiver(msg.receiver);
            other = msg.value.gameObject;
        ...
        private void OnTriggerExit2D(ParadoxNotion.EventData<Collider2D> msg)
        {
            receiver = ResolveReceiver(msg.receiver);
            other = msg.value.gameObject;
    ...
    ///----------------------------------------------------------------------------------------------
    [Name("Trigger2D"), Category("Events/Object"), Description("Called when 2D Trigger based event happen on target")
     , DoNotList]
