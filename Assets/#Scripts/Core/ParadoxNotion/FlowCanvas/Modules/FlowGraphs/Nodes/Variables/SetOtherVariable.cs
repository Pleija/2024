...
namespace FlowCanvas.Nodes
{
    ...
    public class SetOtherVariable<T> : FlowNode
    {
        ...
        public override string name =>
            string.Format("Variable {0} Value", OperationTools.GetOperationString(operation));
        ...
        private void DoSet(Blackboard bb, string name, T value)
        {
            ...
            if (targetVariable == null) targetVariable = (Variable<T>)bb.AddVariable(varName.value, typeof(T));
