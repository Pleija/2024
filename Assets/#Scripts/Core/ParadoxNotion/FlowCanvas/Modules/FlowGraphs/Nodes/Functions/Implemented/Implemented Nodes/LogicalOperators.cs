...
{
    [Category("Operators"), Description("Returns if the object is not null"), Name("Is Valid")]
    ...
    [Category("Operators/Any"), Name(">"), Description("Any Greater Than")]
    ...
    {
        public override bool Invoke(object a, object b) => ObjectUtils.AnyEquals(a, b);
    }

    [Category("Operators/Any"), Name("≠"), Description("Any Not Equal To")]
    ...
    [Category("Operators/Boolean"), Description("True if A or B is true")]
    ...
    [Category("Operators/Boolean"), Description("True if A or B is true, but not both")]
    ...
    [Category("Operators/Boolean"), Description("Inverts the input")]
    ...
    [Category("Operators/Flags"), Name("AND"), Description("Bitwise logical AND & operator")]
    ...
    [Category("Operators/Flags"), Name("OR"), Description("Bitwise logical OR | operator")]
    ...
    [Category("Operators/Flags"), Name("Invert"), Description("Bitwise complement ~ operator")]
