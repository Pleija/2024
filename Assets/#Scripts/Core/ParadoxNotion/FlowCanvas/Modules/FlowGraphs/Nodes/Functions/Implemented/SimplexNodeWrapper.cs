...
namespace FlowCanvas.Nodes
{
    ...
    public class SimplexNodeWrapper<T> : SimplexNodeWrapper where T : SimplexNode
    {
        ...
        public T simplexNode {
            get {
                if (_simplexNode == null) {
                    ...
                    if (_simplexNode != null) GatherPorts();
                }
                return _simplexNode;
            }
        }
        ...
        {
            if (simplexNode != null) simplexNode.SetDefaultParameters(this);
        }

        public override void OnGraphStarted()
        {
            if (simplexNode != null) simplexNode.OnGraphStarted();
        }

        public override void OnGraphPaused()
        {
            if (simplexNode != null) simplexNode.OnGraphPaused();
        }

        public override void OnGraphUnpaused()
        {
            if (simplexNode != null) simplexNode.OnGraphUnpaused();
        }

        public override void OnGraphStoped()
        {
            if (simplexNode != null) simplexNode.OnGraphStoped();
        }

        protected override void RegisterPorts()
        {
            if (simplexNode != null) simplexNode.RegisterPorts(this);
        }
