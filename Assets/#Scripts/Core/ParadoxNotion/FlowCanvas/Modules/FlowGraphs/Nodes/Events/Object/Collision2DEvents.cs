...
namespace FlowCanvas.Nodes
{
    ...
    public class Collision2DEvents_Rigidbody : RouterEventNode<Rigidbody2D>
    {
        ...
        protected override void RegisterPorts()
        {
            ...
            AddValueOutput<Rigidbody2D>("Receiver", () => {
                return receiver;
            });
            AddValueOutput<GameObject>("Other", () => {
                return collision.gameObject;
            });
            AddValueOutput<ContactPoint2D>("Contact Point", () => {
                return collision.contacts[0];
            });
            AddValueOutput<Collision2D>("Collision Info", () => {
                return collision;
            });
        }
        ...
        private void OnCollisionEnter2D(ParadoxNotion.EventData<Collision2D> msg)
        {
        ...
        private void OnCollisionStay2D(ParadoxNotion.EventData<Collision2D> msg)
        {
            receiver = ResolveReceiver(msg.receiver);
            collision = msg.value;
        ...
        private void OnCollisionExit2D(ParadoxNotion.EventData<Collision2D> msg)
        {
            receiver = ResolveReceiver(msg.receiver);
            collision = msg.value;
