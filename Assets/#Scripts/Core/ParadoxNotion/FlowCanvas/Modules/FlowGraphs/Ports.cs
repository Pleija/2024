...
namespace FlowCanvas
{
    ...
    public abstract class Port
    {
        ...
        internal void EnsureCachedGUIContent()
        {
            ...
            if (IsFlowPort()) {
                ...
                var hexColor =
                    ColorUtils.ColorToHex(ParadoxNotion.Design.TypePrefs.GetTypeColor(type));
                ...
                var isWildDef = wildDefType != null && (wildDefType == type ||
                    wildDefType == type.GetEnumerableElementType());
        ...
        public bool IsUnityObject() => typeof(UnityEngine.Object).RTIsAssignableFrom(type);
    ...
    public class FlowInput : Port
    {
        ...
        public FlowInput(FlowNode parent, string name, string ID, FlowHandler pointer) :
            base(parent, name, ID) => this.pointer = pointer;
    ...
    public class FlowOutput : Port
    {
        ...
        private System.Collections.IEnumerator DebugBreakWait(Flow f)
        {
            ParadoxNotion.Services.Logger.LogWarning(string.Format("On Node '{0}'", parent.name),
                "Breakpoint", parent);
            Debug.Break();
    ...
    public abstract class ValueInput : Port
    {
        ...
        {
            return (ValueInput)Activator.CreateInstance(typeof(ValueInput<>).RTMakeGenericType(t),
                new object[] { parent, name, ID });
        }
    ...
    public abstract class ValueOutput : Port
    {
        ...
        {
            return (ValueOutput)Activator.CreateInstance(typeof(ValueOutput<>).RTMakeGenericType(t),
                new object[] { parent, name, ID, getter });
        }
    ...
    public class ValueOutput<T> : ValueOutput
    {
        ...
        public ValueOutput(FlowNode parent, string name, string ID, ValueHandler<T> getter) :
            base(parent, name, ID) => this.getter = getter;
        ...
        public override object GetObjectValue() => (object)getter();
