            ...
            if (EditorTools.GetObjectFoldOut(animParam)) {
                ...
                if (hasExpression) {
                    if (GUILayout.Button(Styles.expressionIcon, GUI.skin.label, GUILayout.Width(18))) {
                        var menu = Slate.Expressions.ExpressionsMenuGenerator.GetExpressionEnvironmentMenu(animParam.GetExpressionEnvironment(), (template) => {
...
#if SLATE_USE_EXPRESSIONS
                if (!animParam.hasActiveExpression) {
                    menu.AddItem(new GUIContent("Set Expression"), false, () => {
                        animParam.scriptExpression = "value";
                    });
                    ...
                    menu.AddItem(new GUIContent("Remove Expression"), false, () => {
