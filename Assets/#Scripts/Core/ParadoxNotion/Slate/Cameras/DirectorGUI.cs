...
namespace Slate
{
    ...
    public class DirectorGUI : MonoBehaviour
    {
        ...
        {
            if (OnGUIEnable != null) OnGUIEnable();
        }
        ...
        private void OnDisable()
        {
            ...
            if (OnGUIDisable != null) OnGUIDisable();
        }
        ...
        {
            if (OnLetterboxGUI != null) OnLetterboxGUI(completion);
        }

        //...
        public static void UpdateDissolve(Texture texture, float completion)
        {
            if (OnCameraDissolve != null) OnCameraDissolve(texture, completion);
        }
        ...
        {
            lastFadeColor = color;
            if (OnScreenFadeGUI != null) OnScreenFadeGUI(color);
        }

        //...
        public static void UpdateSubtitles(string text, Color color)
        {
            if (OnSubtitlesGUI != null) OnSubtitlesGUI(text, color);
        }
        ...
        private void OnGUI()
        {
            if (OnGUIUpdate != null) OnGUIUpdate();
            ///----------------------------------------------------------------------------------------------
