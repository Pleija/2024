...
{
    [Category("Events"), Description("Send a Unity Message to the actor")]
    public class SendMessage : ActorActionClip
    {
        ...
        [Tooltip(
            "If multiple components of the same type exist on gameobject you can specify the index of the component to use here. Leave at -1 to call all found instances")]
