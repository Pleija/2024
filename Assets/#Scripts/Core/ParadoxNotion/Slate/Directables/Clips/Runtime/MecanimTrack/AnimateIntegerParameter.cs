...
{
    [Description(
        "Animate an integer Animator parameter to a value and back to previous value gradualy over a period of time.")]
    public class AnimateIntegerParameter : MecanimBaseClip
    {
        ...
        {
            if (Application.isPlaying) actor.SetInteger(parameterName, lastValue);
        }
    }
}
