...
{
    [Description(
        "Animate an Animator layer weight to a value and back to previous value gradualy over a period of time.")]
    public class AnimateLayerWeight : MecanimBaseClip
    {
        ...
        public override string info => string.Format("Layer '{0}' Weight", layerIndex);
        ...
        {
            if (Application.isPlaying) actor.SetLayerWeight(layerIndex, lastValue);
        }
    }
}
