    ...
    public class SerializedUnityEventInfo : ISerializedReflectedInfo
    {
        ...
        void ISerializationCallbackReceiver.OnAfterDeserialize()
        {
            ...
            if (result is PropertyInfo &&
                typeof(UnityEventBase).RTIsAssignableFrom((result as PropertyInfo).PropertyType)) {
                _memberInfo = result;
                return;
            }
        }
        ...
        public MemberInfo AsMemberInfo() => _memberInfo;
        public string AsString() => _baseInfo != null ? _baseInfo.Replace("|", ".") : "None";
        public override string ToString() => AsString();

        //operator
        public static implicit operator FieldInfo(SerializedUnityEventInfo value) =>
            value != null ? value._memberInfo as FieldInfo : null;

        //operator
        public static implicit operator PropertyInfo(SerializedUnityEventInfo value) =>
            value != null ? value._memberInfo as PropertyInfo : null;
    }
}
