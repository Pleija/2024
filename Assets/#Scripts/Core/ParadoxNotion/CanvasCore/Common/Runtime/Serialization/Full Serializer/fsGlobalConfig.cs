namespace ParadoxNotion.Serialization.FullSerializer
{
    ...
    public static class fsGlobalConfig
    {
        ...
        /// <summary>
        ///     Should deserialization be case sensitive? If this is false and the JSON has multiple members
        ///     with the same
        ///     keys only separated by case, then this results in undefined behavior.
        /// </summary>
        public static bool IsCaseSensitive = false;

        /// <summary>
        ///     The attributes that will force a field or property to *not* be serialized. Ignore
        ///     attribute take predecence.
        /// </summary>
        public static System.Type[] IgnoreSerializeAttributes = {
            typeof(System.NonSerializedAttribute), typeof(fsIgnoreAttribute),
        };

        /// <summary>
        ///     The attributes that will force a field or property to be serialized. Ignore attribute
        ///     take predecence.
        /// </summary>
        public static System.Type[] SerializeAttributes = {
            typeof(UnityEngine.SerializeField), typeof(fsSerializeAsAttribute),
        };
        ...
        /// <summary>
        ///     Enums are serialized using their names by default. Setting this to true will serialize them as
        ///     integers
        ///     instead.
        /// </summary>
