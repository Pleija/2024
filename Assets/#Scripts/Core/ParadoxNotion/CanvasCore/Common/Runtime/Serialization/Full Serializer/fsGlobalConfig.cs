namespace ParadoxNotion.Serialization.FullSerializer
{
    ...
    public static class fsGlobalConfig
    {
        ...
        /// <summary>
        ///     Should deserialization be case sensitive? If this is false and the JSON has multiple members with the same
        ...
        /// <summary>
        ///     Enums are serialized using their names by default. Setting this to true will serialize them as integers
        ///     instead.
        /// </summary>
