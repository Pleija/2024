    ...
    public static class Styles
    {
            ...
            get {
                if (_proxyRightContentLabel == null) {
                    ...
                    _proxyRightContentLabel.margin = new RectOffset(0, 0,
                        _proxyRightContentLabel.margin.top, _proxyRightContentLabel.margin.bottom);
            ...
            get {
                if (_proxyLeftContentLabel == null) {
                    ...
                    _proxyLeftContentLabel.margin = new RectOffset(0, 0,
                        _proxyLeftContentLabel.margin.top, _proxyLeftContentLabel.margin.bottom);
                    _proxyLeftContentLabel.padding = new RectOffset(0, 8,
                        _proxyLeftContentLabel.padding.top, _proxyLeftContentLabel.padding.bottom);
                }
        ...
        public static GUIStyle roundedBox {
            get {
                ...
                if (!UnityEditor.EditorGUIUtility.isProSkin) _roundedBox.normal.background = null;
                return _roundedBox;
            }
        }
...
#if UNITY_2019_3_OR_NEWER
            get {
                return _buttonRight ?? (_buttonRight = new GUIStyle((GUIStyle)"AppCommandRight"));
            }
#else
        ...
        public static GUIStyle highlightBox => _highlightBox ??
            (_highlightBox = new GUIStyle((GUIStyle)"LightmapEditorSelectedHighlight"));
        ...
        public static GUIStyle toolbarSearchTextField {
            ...
            get {
                return _toolbarSearchField ?? (_toolbarSearchField =
                    new GUIStyle((GUIStyle)"ToolbarSeachTextField"));
            }
#endif
        }
...
#else
            get {
                return _toolbarSearchButton ?? (_toolbarSearchButton =
                    new GUIStyle((GUIStyle)"ToolbarSeachCancelButton"));
            }
#endif
        }
        ...
        public static GUIStyle shadowedBackground => _shadowedBackground ??
            (_shadowedBackground = new GUIStyle((GUIStyle)"CurveEditorBackground"));
