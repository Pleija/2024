...
namespace NodeCanvas.DialogueTrees
{
    ...
    public class DialogueTreeController : GraphOwner<DialogueTree>, IDialogueActor
    {
        ...
        {
            if (behaviour != null) behaviour.SetActorReference(paramName, actor);
        }
        ...
        {
            if (behaviour != null) behaviour.SetActorReferences(actors);
        }
        ...
        {
            enableAction = EnableAction.DoNothing;
            disableAction = DisableAction.DoNothing;
