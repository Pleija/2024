...
namespace ParadoxNotion.Design
{
    ...
    partial class EditorUtils
    {
        ...
        public static LayerMask
            LayerMaskField(string prefix, LayerMask layerMask, params GUILayoutOption[] layoutOptions) =>
            LayerMaskField(
        ...
        {
            var optionsAtt =
                info.attributes?.FirstOrDefault(x => x is ListInspectorOptionAttribute) as ListInspectorOptionAttribute;
        ...
        ///<summary>Generic Popup for selection of any element within a list</summary>
        public static T
            Popup<T>(string prefix, T selected, IEnumerable<T> options, params GUILayoutOption[] GUIOptions) =>
            Popup<T>(
