...
namespace ParadoxNotion.Design
{
    ...
    public static class CopyBuffer
    {
        ...
        public static bool Has<T>() => cachedCopies.TryGetValue(typeof(T), out var json);

        ///<summary>Returns true if copy exist and the copy</summary>
        public static bool TryGet<T>(out T copy)
        {
            copy = Get<T>();
            return Equals(copy, default(T)) == false;
        }
        ...
        ///----------------------------------------------------------------------------------------------
        ///<summary></summary>
        public static bool HasCache<T>() => cachedObjects.TryGetValue(typeof(T), out var obj);
        ...
        {
            if (cachedObjects.TryGetValue(typeof(T), out var obj)) return (T)obj;
            return default;
        }
