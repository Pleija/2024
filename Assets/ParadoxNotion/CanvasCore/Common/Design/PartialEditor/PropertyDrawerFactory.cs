...
namespace ParadoxNotion.Design
{
    ...
    public class DefaultObjectDrawer : ObjectDrawer<object>
    {
        ...
        public DefaultObjectDrawer(Type objectType) => this.objectType = objectType;

        public override object OnGUI(GUIContent content, object instance) =>
            EditorUtils.DrawEditorFieldDirect(content, instance, objectType, info);
    }
    ...
    public class DefaultAttributeDrawer : AttributeDrawer<DrawerAttribute>
    {
        ...
        public DefaultAttributeDrawer(Type attributeType) => this.attributeType = attributeType;
