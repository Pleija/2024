...
namespace ParadoxNotion.Design
{
    ...
    public static class Styles
    {
        ...
        public static GUIStyle highlightBox =>
            _highlightBox ?? (_highlightBox = new GUIStyle((GUIStyle)"LightmapEditorSelectedHighlight"));
...
#else
            get {
                return _toolbarSearchField ?? (_toolbarSearchField = new GUIStyle((GUIStyle)"ToolbarSeachTextField"));
            }
#endif
        }
        ...
        public static GUIStyle toolbarSearchCancelButton {
            ...
            get {
                return _toolbarSearchButton ??
                    (_toolbarSearchButton = new GUIStyle((GUIStyle)"ToolbarSeachCancelButton"));
            }
#endif
        }
