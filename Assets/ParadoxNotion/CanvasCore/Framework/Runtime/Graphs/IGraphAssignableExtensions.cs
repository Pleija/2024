...
namespace NodeCanvas.Framework
{
    public static class IGraphAssignableExtensions
    {
        ...
        {
            if (assignable.subGraph == assignable.currentInstance) return assignable.currentInstance;
            Graph instance = null;
        ...
        public static void TryWriteAndBindMappedVariables(this IGraphAssignable assignable)
        {
            ...
            for (var i = 0; i < assignable.variablesMap.Count; i++) {
                ...
                var targetSubVariable =
                    assignable.currentInstance.blackboard.GetVariableByID(bbParam.targetSubGraphVariableID);
