    ...
    partial class GraphEditor
    {
        ...
        private static Rect ShowInspectorGUIPanel(Graph graph, Vector2 canvasMousePos)
        {
            ...
            var inspectedElement =
                Prefs.animatePanels ? inspectorPanelPreviousSelection : GraphEditorUtility.activeElement;
            ...
            var headerHeight = 30;
            inspectorPanel.x =
                Mathf.Lerp(-Prefs.inspectorPanelWidth - scrollWidth, posX, inspectorPanelAnimFloat.value);
            ...
            if (Prefs.showNodePanel) {
                ...
                inspectorPanelScrollPos =
                    GUI.BeginScrollView(position, inspectorPanelScrollPos, viewRect, false, false);
                ...
                if (GUI.Button(contentRect, "<b>...</b>", Styles.centerLabel)) Prefs.showNodePanel = true;
            }
            GUI.EndGroup();
            GUI.EndClip();
        ...
        private static Rect ShowBlackboardGUIPanel(Graph graph, Vector2 canvasMousePos)
        {
            ...
            if (Prefs.showBlackboard) {
                ...
                blackboardPanelScrollPos =
                    GUI.BeginScrollView(position, blackboardPanelScrollPos, viewRect, false, false);
                GUILayout.BeginArea(contentRect);
                ...
                EditorGUIUtility.AddCursorRect(contentRect, MouseCursor.Link);
                if (GUI.Button(contentRect, "<b>...</b>", Styles.centerLabel)) Prefs.showBlackboard = true;
            }
            GUI.EndGroup();
            GUI.EndClip();
