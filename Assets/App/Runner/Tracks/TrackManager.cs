...
namespace Runner.Tracks
{
    ...
    public class TrackManager : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            m_Segments[0]
                    .GetPointAtInWorldUnit(m_CurrentSegmentDistance, out currentPos,
                        out currentRot);
        ...
        public IEnumerator Begin()
        {
            if (!m_Rerun) {
                ...
                if (m_IsTutorial)
                    ...
                    m_CurrentThemeData = ThemeDatabase.GetThemeData(
                ...
                AnalyticsEvent.GameStart(new Dictionary<string, object> {
                    ...
                    { "character", player.characterName }, {
                        ...
                        PlayerData.instance.usedAccessory >= 0
                                ? player.accessories[PlayerData.instance.usedAccessory]
                                        .accessoryName : "none"
                    },
                });
#endif
        ...
        public IEnumerator SpawnNewSegment()
        {
            if (!m_IsTutorial)
                if (m_CurrentThemeData.zones[m_CurrentZone].length < m_CurrentZoneDistance)
                    ChangeZone();
            var segmentUse = Random.Range(
                0, m_CurrentThemeData.zones[m_CurrentZone].prefabList.Length);
            ...
            newSegment.objectRoot.localScale = new Vector3(
                1.0f / newSegment.transform.localScale.x, 1, 1);
                    ...
                    if (laneValid) {
                        ...
                        if (Random.value < powerupChance) {
                            ...
                            if (consumableDatabase.consumbales[picked].canBeSpawned) {
                                ...
                                toUse = Instantiate(op.Result, pos, rot)
                                        .Of(x => x
