...
{
    /// <summary>
    ///     Defines a consumable (called "power up" in game). Each consumable is derived from this and
    ...
    public abstract class Consumable : MonoBehaviour
    {
        ...
        public virtual bool CanBeUsed(CharacterInputController c) => true;
        ...
        public virtual void Tick(CharacterInputController c)
        {
            ...
            if (m_SinceStart >= duration) m_Active = false;
        }
