...
{
    /// <summary>
    ///     Pushed on top of the GameManager during gameplay. Takes care of initializing all the UI and
    ///     start the TrackManager
    ...
    public class GameState : AState
    {
        ...
        public bool m_AdsInitialised;
        public bool m_GameoverSelectionDone;
        ...
        public int m_TutorialClearedObstacle;
        public bool m_CountObstacles = true;
        public bool m_DisplayTutorial;
        public int m_CurrentSegmentObstacleIndex;
        public TrackSegment m_NextValidSegment;
        ...
        public void Pause(bool displayMenu = true)
        {
            ...
            if (m_Finished || AudioListener.pause) return;
        ...
        public void UpdateUI()
        {
            ...
            if (trackManager.timeToStart >= 0) {
                ...
                m_CountdownRectTransform.localScale = Vector3.one
                        * (1.0f
                            - (trackManager.timeToStart - Mathf.Floor(trackManager.timeToStart)));
            }
            else {
        ...
        public void PremiumForLife()
        {
            ...
            trackManager.characterController.premium -= Mathf.Min(
                trackManager.characterController.premium, 3);
            SecondWind();
        }
        ...
        private void TutorialCheckObstacleClear()
        {
            ...
            var nextObstaclePosition =
                    m_CurrentSegmentObstacleIndex
                    < trackManager.currentSegment.obstaclePositions.Length
                            ? trackManager.currentSegment.obstaclePositions[
                                m_CurrentSegmentObstacleIndex] : float.MaxValue;
