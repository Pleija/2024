...
//    }
        ...
        public static T FindOrNewManager<T>(this Component self) where T : Component {
            return self.GetComponentInChildren<T>() ?? Object.FindObjectOfType<T>() ?? self.AddComponentOnce<T>();
        }
