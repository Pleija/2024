...
namespace Extensions
{
    ...
    {
        public static bool Is<T>(this Type aType) {
            return typeof(T).IsAssignableFrom(aType);
        }
        ...
        public static bool IsDerivedFromOpenGenericType(this Type type, Type openGenericType) {
            ...
            return type.GetTypeHierarchy().Where(t => t.IsGenericType).Select(t => t.GetGenericTypeDefinition())
