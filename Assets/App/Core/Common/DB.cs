...
//         public static void CreateTable<T>(T obj = default) where T : DbTable {
//             Connection.CreateTable<T>();
//         }
//
//         public static T Insert<T>(T obj) where T : DbTable {
//             return Update(obj);
//
// //        Connection.CreateTable<T>();
...
//         }
//
//         public static T Load<T>(Expression<Func<T, bool>> predExpr = null, T target = default) where T : IData, new() {
//             return Table<T>().FirstOrDefault(predExpr);
//         }
//
//         public static TableQuery<T> Table<T>(T obj = default) where T : new() {
//             return Connection.Table<T>();
//         }
//
//         public static T Save<T>(T obj) where T : DbTable {
//             return Update(obj);
//         }
//
...
//         }
//
//         public static T Update<T>(T obj) where T : DbTable {
//             Connection.CreateTable<T>();
