...
/// <remarks>
///     Enums with this attribute are not detected by EditorGui.ChangeCheck due to waiting before
///     executing
/// </remarks>
...
public class DefaultNoodleColorAttribute : Attribute
{
    ...
    public DefaultNoodleColorAttribute(float colorR, float colorG, float colorB,
        float selectedColorR, float selectedColorG, float selectedColorB)
    {
        SelectedColor = new Color(selectedColorR, selectedColorG, selectedColorB);
        Color = new Color(colorR, colorG, colorB);
    }

    public DefaultNoodleColorAttribute(byte colorR, byte colorG, byte colorB, byte selectedColorR,
        byte selectedColorG, byte selectedColorB)
    {
