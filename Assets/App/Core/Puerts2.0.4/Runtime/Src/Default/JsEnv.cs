...
namespace Puerts
{
    ...
    public partial class JsEnv : IDisposable
    {
        ...
        internal TypeManager TypeRegister {
            get {
#if !PUERTS_GENERAL
                Debug.LogWarning("use JsEnv.TypeManager instead");
#endif
                return TypeManager;
            }
        }

        internal readonly TypeManager TypeManager;
        ...
        public JsEnv(ILoader loader, int debugPort, IntPtr externalRuntime, IntPtr externalContext)
        {
            ...
            if (libVersion != libVersionExpect)
                throw new InvalidProgramException("expect lib version "
                    + libVersionExpect
                    + ", but got "
                    + libVersion);
            ...
            PuertsDLL.SetGlobalFunction(isolate, "__tgjsRegisterTickHandler",
                StaticCallbacks.JsEnvCallbackWrap,
                AddCallback(RegisterTickHandler));
            PuertsDLL.SetGlobalFunction(isolate, "__tgjsGetGenericMethod",
                StaticCallbacks.JsEnvCallbackWrap,
                AddCallback(GetGenericMethod));
        ...
        */
        ...
        private void RegisterTickHandler(IntPtr isolate, IntPtr info, IntPtr self, int paramLen)
        {
            try {
                ...
                PuertsDLL.ThrowException(isolate,
                    "registerTickHandler throw c# exception:"
                    + e.Message
                    + ",stack:"
                    + e.StackTrace);
            }
        ...
        private void GetGenericMethod(IntPtr isolate, IntPtr info, IntPtr self, int paramLen)
        {
            try {
                ...
                var callbackID = AddCallback(
                    new GenericMethodWrap(methodName, this, type, genericArguments).Invoke);
