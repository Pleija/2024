...
namespace Puerts
{
    ...
    public class JsEnv : IDisposable
    {
        ...
        public IntPtr Isolate {
            get { return PuertsIl2cpp.NativeAPI.GetIsolate(nativeJsEnv); }
        }
        ...
        public JsEnv(ILoader loader, int debugPort = -1)
        {
            ...
            PuertsIl2cpp.NativeAPI.SetObjectPool(nativeJsEnv, PuertsIl2cpp.NativeAPI.GetMethodInfoPointer(objectPoolAddMethodInfo), PuertsIl2cpp.NativeAPI.GetMethodPointer(objectPoolAddMethodInfo), PuertsIl2cpp.NativeAPI.GetMethodInfoPointer(objectPoolRemoveMethodInfo), PuertsIl2cpp.NativeAPI.GetMethodPointer(objectPoolRemoveMethodInfo), PuertsIl2cpp.NativeAPI.GetObjectPointer(objectPool));
        ...
        public T ExecuteModule<T>(string specifier, string exportee)
        {
            ...
            if (moduleExecutor == null)
                moduleExecutor =
                        PuertsIl2cpp.NativeAPI.GetModuleExecutor(nativePesapiEnv, typeof(Func<string, JSObject>));
