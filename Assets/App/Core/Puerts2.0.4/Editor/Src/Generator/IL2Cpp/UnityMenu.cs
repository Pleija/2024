    ...
    namespace Generator
    {
        public class UnityMenu
        {
            ...
            public static void GenerateCppPlugin()
            {
                ...
                var saveTo =
                        Path.Combine(Path.GetFullPath("Packages/com.tencent.puerts.core/"), "Plugins/puerts_il2cpp/");
#else
                var saveTo =
                        Path.Combine(Puerts.Configure.GetCodeOutputDirectory(), "Plugins/puerts_il2cpp/");
#endif
...
#elif PUERTS_CPP_OUTPUT_TO_NATIVE_SRC_UPM
                var saveTo =
                        Path.Combine(Path.GetFullPath("Packages/com.tencent.puerts.core/"), "../../../", "native_src_il2cpp", "Src");
#else
