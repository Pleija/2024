...
namespace XNode
{
    ...
    public abstract class Node : ScriptableObject
    {
        ...
        /// <summary>
        ///     Used by <see cref="InputAttribute" /> and <see cref="OutputAttribute" /> to determine
        ///     when to display the field value associated with a <see cref="NodePort" />
        /// </summary>
        ...
        public enum TypeConstraint
        {
            ...
            /// <summary>
            ///     Allow connections where input value type is assignable from output value type (eg.
            ...
            /// <summary>
            ///     Allow connections where output value type is assignable from input value or input value
            ///     type is assignable from output value type
            /// </summary>
            InheritedAny,
        }
        ...
        /// <summary>
        ///     Update static ports and dynamic ports managed by DynamicPortLists to reflect class
        ///     fields. This happens automatically on enable or on redrawing a dynamic port list.
        /// </summary>
...
#region Obsolete
        ...
        public NodePort AddInstanceInput(Type type,
            ConnectionType connectionType = ConnectionType.Multiple,
            TypeConstraint typeConstraint = TypeConstraint.None, string fieldName = null) =>
                AddDynamicInput(type, connectionType, typeConstraint, fieldName);

        [Obsolete("Use AddDynamicOutput instead")]
        public NodePort AddInstanceOutput(Type type,
            ConnectionType connectionType = ConnectionType.Multiple,
            TypeConstraint typeConstraint = TypeConstraint.None, string fieldName = null) =>
        ...
        private NodePort AddInstancePort(Type type, NodePort.IO direction,
            ConnectionType connectionType = ConnectionType.Multiple,
            TypeConstraint typeConstraint = TypeConstraint.None, string fieldName = null) =>
                AddDynamicPort(type, direction, connectionType, typeConstraint, fieldName);
...
#region Dynamic Ports
        ...
        public NodePort AddDynamicInput(Type type,
            ConnectionType connectionType = ConnectionType.Multiple,
            TypeConstraint typeConstraint = TypeConstraint.None, string fieldName = null) =>
                AddDynamicPort(type, NodePort.IO.Input, connectionType, typeConstraint, fieldName);
        ...
        public NodePort AddDynamicOutput(Type type,
            ConnectionType connectionType = ConnectionType.Multiple,
            TypeConstraint typeConstraint = TypeConstraint.None, string fieldName = null) =>
                AddDynamicPort(type, NodePort.IO.Output, connectionType, typeConstraint, fieldName);
            ...
            TypeConstraint typeConstraint = TypeConstraint.None, string fieldName = null)
        {
            ...
            var port = new NodePort(fieldName, type, direction, connectionType, typeConstraint,
                this);
...
#region Inputs/Outputs
        ...
        /// <summary>
        ///     Return all input values for a specified port. Returns fallback value if no ports are
        ///     connected
        /// </summary>
        /// <param name="fieldName">Field name of requested input port</param>
        /// <param name="fallback">If no ports are connected, this value will be returned</param>
        ...
        /// <summary>
        ///     Returns a value based on requested port output. Should be overridden in all derived nodes
        ///     with outputs.
        /// </summary>
...
#region Attributes
#if ODIN_INSPECTOR
        [DontApplyToListElements, AttributeUsage(AttributeTargets.Field
#if ODIN_INSPECTOR
        ...
        public class InputAttribute : Attribute
        {
            ...
            ///     If true, will display a reorderable list of inputs instead of a
            ///     single port. Will automatically add and display values for lists and arrays
            /// </param>
        ...
        public class OutputAttribute : Attribute
        {
            ...
            /// <param name="dynamicPortList">
            ///     If true, will display a reorderable list of outputs instead of a
            ///     single port. Will automatically add and display values for lists and arrays
            /// </param>
            ...
            public OutputAttribute(ShowBackingValue backingValue, ConnectionType connectionType,
                bool dynamicPortList) : this(backingValue, connectionType, TypeConstraint.None,
                dynamicPortList) { }
        ...
        public class DisallowMultipleNodesAttribute : Attribute
        {
            ...
            public DisallowMultipleNodesAttribute(int max = 1) => this.max = max;
        }
