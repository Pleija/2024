...
function pressArgs(args){
    for (let i = 0; i < args.length; i++) {
        if(typeof args[i] == "object" && puer.$typeof(args[i]) == null){
...
puer.on('uncaughtException', function (err) {
    ...
    CS.UnityEngine.Debug.LogError(getTrack(output));
});
// 捕获async异常
