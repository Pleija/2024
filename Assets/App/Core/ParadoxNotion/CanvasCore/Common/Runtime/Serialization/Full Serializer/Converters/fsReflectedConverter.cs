...
namespace ParadoxNotion.Serialization.FullSerializer.Internal
{
    public class fsReflectedConverter : fsConverter
    {
            ...
            Type storageType)
        {
            ...
            if (fsGlobalConfig.SerializeDefaultValues == false && !(instance is Object))
            ...
            for (var i = 0; i < metaType.Properties.Length; ++i) {
                ...
                if (property.AsReference && Serializer.IgnoreSerializeCycleReferences) continue;
        ...
        public override fsResult TryDeserialize(fsData data, ref object instance, Type storageType)
        {
            ...
            if (data.AsDictionary.Count == 0) return fsResult.Success;
