...
{
    /// <summary>
    ///     Will receive callbacks on serialization/deserialization. Multiple collectors are possible
    ///     and are stacked.
    /// </summary>
    public interface ISerializationCollector : ISerializationCollectable
    {
        ...
        /// <summary>
        ///     Called when a collectable is to be collected. The depth is local to this collector only
        ///     starting from 0
        /// </summary>
