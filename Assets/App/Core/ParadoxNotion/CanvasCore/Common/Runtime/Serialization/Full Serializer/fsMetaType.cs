...
namespace ParadoxNotion.Serialization.FullSerializer
{
    ...
    public class fsMetaType
    {
        ...
        {
            var fields = reflectedType.RTGetFields();
        ...
        public static bool CanSerializeField(FieldInfo field)
        {
            ...
            if (field.RTIsDefined<CompilerGeneratedAttribute>(true)) return false;
        ...
        private static ObjectGenerator GetGenerator(Type reflectedType)
        {
            ...
            if (reflectedType.IsValueType
                || reflectedType.RTIsDefined<fsUninitialized>(true)
        ...
        private static bool HasDefaultConstructor(Type reflectedType)
        {
            ...
            if (reflectedType.IsArray) return true;

            // value types (ie, structs) always have a default constructor
            if (reflectedType.IsValueType) return true;
        ...
        public object GetDefaultInstance()
        {
            ...
            if (_defaultInstances.TryGetValue(reflectedType, out instance)) return instance;
