...
namespace ParadoxNotion.Design
{
    ...
    public static class XMLDocs
    {
        ...
        public static string GetMethodParameter(MethodBase method, ParameterInfo parameter) =>
                GetMethodParameter(method, parameter.Name);
        ...
        private static XmlElement GetXmlElementForMember(MemberInfo memberInfo)
        {
        ...
        private static XmlElement GetTypeDoc(Type type) => GetDoc(type, $"T:{type.FullName}");

        private static XmlElement GetMemberDoc(MemberInfo memberInfo)
        {
            if (memberInfo is MethodInfo) {
