...
namespace ParadoxNotion.Design
{
    ...
    public class TypePrefsEditorWindow : OdinEditorWindow
    {
        ...
        protected override void OnGUI()
        {
            ...
            if (GUILayout.Button("Save Preset", EditorStyles.miniButtonMid)) {
                ...
                if (!string.IsNullOrEmpty(path)) {
                    File.WriteAllText(path,
                        JSONSerializer.Serialize(typeof(List<Type>), typeList, null, true));
                    AssetDatabase.Refresh();
                }
            }
            ...
            if (GUILayout.Button("Load Preset", EditorStyles.miniButtonRight)) {
                ...
                if (!string.IsNullOrEmpty(path)) {
                    ...
                    typeList = JSONSerializer.Deserialize<List<Type>>(json);
                    Save();
                }
            }
            ...
            EditorGUILayout.HelpBox(syncPath != null
        ...
        private void RemoveType(Type t)
        {
            typeList.Remove(t);
            Save();
            ShowNotification(
