...
namespace NodeCanvas.Editor
{
    ...
    public class GraphOwnerInspector : UnityEditor.Editor
    {
        ...
        public bool isBoundGraphOnPrefabInstance => !isOwnerPeristant
                && owner.graphIsBound
        ...
        {
            var newGraph = (Graph)CreateInstance(owner.graphType);
        ...
        public override void OnInspectorGUI()
        {
            ...
            DoStandardFields();
            GUI.enabled = (!isBoundGraphOnPrefabInstance || !owner.lockBoundGraphPrefabOverrides)
                    && !isBoundGraphOnPrefabRoot;
        ...
        {
            EditorGUILayout.HelpBox(owner.GetType().Name
                + " needs a "
                + graphTypeName
        ...
        private void DoValidGraphControls()
        {
            ...
            if (owner.graph != null) {
                if (owner.graphIsBound) {
                    ...
                    owner.graph.comments = GUILayout.TextArea(
                        owner.graph.comments, GUILayout.Height(45));
        ...
        private void DoExposedVariablesMapping()
        {
            ...
            foreach (var variable in subTreeVariables) {
                ...
                if (owner.exposedParameters == null)
                    owner.exposedParameters = new List<ExposedParameter>();
                var exposedParam =
