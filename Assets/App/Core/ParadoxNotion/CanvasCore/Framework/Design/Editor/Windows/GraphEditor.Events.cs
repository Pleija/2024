    ...
    partial class GraphEditor
    {
        ...
        private static void HandlePostNodesGraphEvents(Graph graph, Vector2 canvasMousePos)
        {
            ...
            if (GUIUtility.keyboardControl == 0) {
                ...
                if (e.type == EventType.ExecuteCommand) {
                    ...
                    if (e.commandName == "Copy" || e.commandName == "Cut") {
                        ...
                        if (selection != null) {
                            CopyBuffer.SetCache(Graph.CloneNodes(selection).ToArray());
            ...
            if (GraphEditorUtility.allowClick) {
                ...
                var isShortcut = e.type == EventType.KeyDown
        ...
        private static GenericMenu GetAddNodeMenu(Graph graph, Vector2 canvasMousePos)
        {
            ...
            if (CopyBuffer.TryGetCache<Node[]>(out var copiedNodes) && copiedNodes.Length > 0)
