...
namespace NodeCanvas.Editor
{
    ...
    {
        private static readonly GUILayoutOption[] layoutOptions = {
        ...
        ///     object
        /// </summary>
        private void _InspectorGUI(IBlackboard bb, Object overrideContextObject = null)
        {
            ...
            if (contextObject != null
                && PrefabUtility.IsPartOfPrefabInstance(contextObject)
            ...
            if (GUI.changed || Event.current.rawType == EventType.MouseUp) {
                ...
                try {
                    ...
                    Logger.LogError("Blackboard has duplicate names!", LogTag.EDITOR, bb);
                }
            }
        }
        ...
        private GenericMenu GetAddVariableMenu(IBlackboard bb, Object contextParent)
        {
            ...
            if (bb.propertiesBindTarget != null) {
                foreach (var comp in bb.propertiesBindTarget.GetComponents(typeof(Component))
                    ...
                    menu = EditorUtils.GetInstancePropertySelectionMenu(comp.GetType(),
                        typeof(object), AddBoundProp, false, false, menu,
                        "Bound (Self)");
                }
