...
namespace NodeCanvas.Framework
{
    ...
    public static class IBlackboardExtensions
    {
        ...
        public static Variable AddVariable(this IBlackboard blackboard, string varName, Type type)
        {
            ...
            var variableType = typeof(Variable<>).RTMakeGenericType(type);
        ...
        public static T GetVariableValue<T>(this IBlackboard blackboard, string varName)
        {
            ...
            if (variable is Variable<T>) return variable.value;
            ...
            try {
                ...
                Logger.LogError(string.Format(
                    "Can't cast value of variable with name '{0}' to type '{1}'", varName,
            ...
            Type newType)
        {
            ...
            var variableType = typeof(Variable<>).RTMakeGenericType(newType);
            var newVariable = (Variable)Activator.CreateInstance(variableType, name, id);
