...
namespace NodeCanvas.Framework
{
    ...
    [fsObject(Processor = typeof(fsBBParameterProcessor)), SpoofAOT, Serializable, fsAutoInstance,
     fsUninitialized]
#endif
    ...
    public abstract class BBParameter : ISerializationCollectable, ISerializationCallbackReceiver
    {
        ...
        public bool useBlackboard {
            ...
            set {
                ...
                if (value && name == null) name = string.Empty;
            }
        }
        ...
        public static BBParameter CreateInstance(Type t, IBlackboard bb)
        {
            ...
            var newBBParam =
                    (BBParameter)Activator.CreateInstance(
                        typeof(BBParameter<>).RTMakeGenericType(t));
            newBBParam.bb = bb;
            return newBBParam;
        }
        ...
        public void SetTargetVariable(IBlackboard targetBB, Variable targetVariable)
        {
            if (targetVariable != null) {
                ...
                _name = targetBB is GlobalBlackboard ? string.Format(
                    "{0}/{1}", targetBB.identifier, targetVariable.name) : targetVariable.name;
        ...
        public sealed override string ToString()
        {
            ...
            if (useBlackboard) {
                ...
                if (EditorGUIUtility.isProSkin)
                    return varRef != null ? text : string.Format(
                        "<color=#FF6C6C>{0}</color>", text);
