...
namespace NodeCanvas.Framework
{
    ...
    public class Blackboard : MonoBehaviour, ISerializationCallbackReceiver, IBlackboard
    {
        ...
        public void SelfSerialize()
        {
            ...
            var newSerialization = JSONSerializer.Serialize(
                typeof(BlackboardSource), _blackboard, newReferences);
            ...
            if (newSerialization != _serializedBlackboard
                ...
                for (var i = 0; i < _blackboard.variables.Count; i++) {
                    ...
                    serializedVariable._json = JSONSerializer.Serialize(typeof(Variable),
                        _blackboard.variables.ElementAt(i).Value,
                        serializedVariable._references);
        ...
        public void SelfDeserialize()
        {
            ...
            if (!string.IsNullOrEmpty(
                ...
                JSONSerializer.TryDeserializeOverwrite(_blackboard, _serializedBlackboard,
                    _objectReferences);
        ...
        public string Serialize(List<Object> references, bool pretyJson = false) =>
                JSONSerializer.Serialize(typeof(BlackboardSource), _blackboard, references,
                    pretyJson);
        ...
        /// </summary>
        public bool Deserialize(string json, List<Object> references,
