...
namespace NodeCanvas.Framework
{
    ...
    [fsObject(Processor = typeof(fsRecoveryProcessor<Node, MissingNode>)), SpoofAOT, Serializable,
    ...
    public abstract partial class Node : IGraphElement, ISerializationCollectable
    {
        ...
        public Node Duplicate(Graph targetGraph)
        {
            ...
            //deep clone
            var newNode = JSONSerializer.Clone(this);
        ...
        public Status Execute(Component agent, IBlackboard blackboard)
        {
            ...
            if (isBreakpoint) {
                if (status == Status.Resting) {
                    var breakEditor = Prefs.breakpointPauseEditor;
        ...
        {
            if (msg is Exception)
                Logger.LogException((Exception)msg, LogTag.EXECUTION, this);
            else
