...
{
    [Obsolete, Category("Mutators (beta)"), Name("Node Toggler"),
     Description(
    ...
    public class NodeToggler : BTNode
    {
        ...
        protected override void OnNodeInspectorGUI()
        {
            ...
            toggleMode = (ToggleMode)EditorGUILayout.EnumPopup("Toggle Mode", toggleMode);
        }
