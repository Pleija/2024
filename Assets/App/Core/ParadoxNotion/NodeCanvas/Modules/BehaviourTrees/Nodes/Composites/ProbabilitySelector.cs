...
namespace NodeCanvas.BehaviourTrees
{
    ...
    public class ProbabilitySelector : BTComposite
    {
        ...
        protected override Status OnExecute(Component agent, IBlackboard blackboard)
        {
            ...
            if (tmpDice < prob) return Status.Failure;
        ...
        private float GetTotal()
        {
            ...
            for (var i = 0; i < childWeights.Count; i++) total += childWeights[i].value;
            return total;
        }
        ...
        {
            BBParameterEditor.ParameterField("Weight", childWeights[i]);
        }
        ...
        protected override void OnNodeInspectorGUI()
        {
            ...
            for (var i = 0; i < childWeights.Count; i++) {
                ...
                childWeights[i] =
                        (BBParameter<float>)BBParameterEditor.ParameterField("Weight",
                            childWeights[i]);
            ...
            GUILayout.Space(5);
            GUILayout.BeginHorizontal();
            failChance = (BBParameter<float>)BBParameterEditor.ParameterField(
                "Direct Failure Chance", failChance);
