...
namespace NodeCanvas.BehaviourTrees
{
    ...
    {
        public enum MonitorMode { Failure = 0, Success = 1, AnyStatus = 10 }
        public enum ReturnStatusMode { OriginalDecoratedChildStatus, NewDecoratorActionStatus }
        ...
        protected override Status OnExecute(Component agent, IBlackboard blackboard)
        {
            ...
            return returnMode == ReturnStatusMode.NewDecoratorActionStatus
                    && decoratorActionStatus != Status.Resting ? decoratorActionStatus
                            : newChildStatus;
        }
