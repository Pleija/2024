...
namespace NodeCanvas.StateMachines
{
    ...
    public class SuperActionState : FSMState
    {
        ...
        protected override void OnUpdate()
        {
            if (!enterListFinished) {
                ...
                if (enterListStatus != Status.Running) {
                    ...
                    if (_onUpdateList.actions.Count == 0) Finish(enterListStatus);
                }
            }
        ...
        protected override void OnNodeInspectorGUI()
        {
            ...
            foldEnter = EditorGUILayout.Foldout(foldEnter,
            ...
            foldUpdate = EditorGUILayout.Foldout(foldUpdate,
            ...
            EditorUtils.Separator();
            foldExit = EditorGUILayout.Foldout(foldExit,
