...
namespace Slate
{
    ...
    {
        public bool ForceStepMode() => true;
        public int RequiredCurvesCount() => 1;
        public object ConvertToObject(params float[] floats) => floats[0] >= 1;
        ...
        {
            return new float[1] { (bool)info.RTGetFieldOrPropValue(target) ? 1 : 0 };
        }
    }
    ...
    public struct Animated_Int : IAnimatedParameterModel
    {
        public bool ForceStepMode() => true;
        public int RequiredCurvesCount() => 1;
        public object ConvertToObject(params float[] floats) => (int)floats[0];
        ...
        public float[] GetDirect(object target, MemberInfo info)
        {
            return new float[1] { (int)info.RTGetFieldOrPropValue(target) };
        }
    }
    ...
    public struct Animated_Float : IAnimatedParameterModel
    {
        ...
        public int RequiredCurvesCount() => 1;
        public object ConvertToObject(params float[] floats) => floats[0];
        ...
        public void SetDirect(object target, MemberInfo info, params float[] floats)
        {
            ...
            setter(target, floats[0]);
        }

        public float[] GetDirect(object target, MemberInfo info)
        {
            return new float[1] { (float)info.RTGetFieldOrPropValue(target) };
        }
    }
    ...
    {
        public bool ForceStepMode() => false;
        public int RequiredCurvesCount() => 2;
        public object ConvertToObject(params float[] floats) => new Vector2(floats[0], floats[1]);
        ...
        public float[] GetDirect(object target, MemberInfo info)
        {
            var vector = (Vector2)info.RTGetFieldOrPropValue(target);
            return new float[2] { vector.x, vector.y };
        }
    }
    ...
    public struct Animated_Vector3 : IAnimatedParameterModel
    {
        ...
        public float[] GetDirect(object target, MemberInfo info)
        {
            var vector = (Vector3)info.RTGetFieldOrPropValue(target);
            return new float[3] { vector.x, vector.y, vector.z };
        }
    }
    ...
    public struct Animated_Color : IAnimatedParameterModel
    {
        ...
        public float[] GetDirect(object target, MemberInfo info)
        {
            var color = (Color)info.RTGetFieldOrPropValue(target);
            return new float[4] { color.r, color.g, color.b, color.a };
        }
    }
    ...
    public struct Animated_Vector4 : IAnimatedParameterModel
    {
        ...
        public string GetKeyLabel(params float[] floats) => string.Format("({0},{1},{2},{3})",
            floats[0].ToString("0"), floats[1].ToString("0"),
            floats[2].ToString("0"), floats[3].ToString("0"));
        ...
        public float[] GetDirect(object target, MemberInfo info)
        {
            var vector = (Vector4)info.RTGetFieldOrPropValue(target);
            return new float[4] { vector.x, vector.y, vector.z, vector.w };
        }
    }
    ...
    public struct Animated_Quaternion : IAnimatedParameterModel
    {
        ...
        public float[] GetDirect(object target, MemberInfo info)
        {
            var quaternion = (Quaternion)info.RTGetFieldOrPropValue(target);
            return new float[4] { quaternion.x, quaternion.y, quaternion.z, quaternion.w };
        }
    }
    ...
    public struct Animated_Rect : IAnimatedParameterModel
    {
        ...
        public float[] GetDirect(object target, MemberInfo info)
        {
            var rect = (Rect)info.RTGetFieldOrPropValue(target);
            return new float[4] { rect.x, rect.y, rect.width, rect.height };
        }
    }
    ...
    public struct Animated_Bounds : IAnimatedParameterModel
    {
        ...
        public float[] GetDirect(object target, MemberInfo info)
        {
            var bounds = (Bounds)info.RTGetFieldOrPropValue(target);
            return new float[6] {
                bounds.center.x, bounds.center.y, bounds.center.z, bounds.size.x, bounds.size.y,
                bounds.size.z,
            };
