...
namespace Slate
{
    [AddComponentMenu("SLATE/Shot Camera"), RequireComponent(typeof(Camera))]
    ...
    public class ShotCamera : MonoBehaviour, IDirectableCamera
    {
        ...
        [SerializeField, FormerlySerializedAs("_focalPoint")]
        private float _focalDistance;

        [SerializeField, FormerlySerializedAs("_focalRange")]
        private float _focalLength;

        [SerializeField]
        private float _focalAperture;
        ...
        public Vector3 localEulerAngles {
            get => transform.GetLocalEulerAngles();
        ...
        {
            dynamicController.UpdateControllerHard(this, directable);
        }
        ...
        public static ShotCamera Create(Transform targetParent = null)
        {
            ...
            if (targetParent == null) {
                root = SceneManager.GetActiveScene()
                        .GetRootGameObjects()
            ...
            if (SceneView.lastActiveSceneView != null) {
                ...
                var is2DMode = SceneView.lastActiveSceneView.in2DMode;
                ...
                Debug.Log(
                    "Remember that creating a ShotCamera with the Scene View open, creates it at the editor camera position");
            }
#endif
            return shot;
        }
        ...
        private void OnDirectorGUI()
        {
            var selectedShotClip = CutsceneUtility.selectedObject as CameraShot;
            if (selectedShotClip != null
                        && selectedShotClip.targetShot == this
                        && selectedShotClip.RootTimeWithinRange())
        ...
        {
            var selectedShotClip = CutsceneUtility.selectedObject as CameraShot;
            if ((selectedShotClip != null && selectedShotClip.targetShot == this)
            ...
            if (position.y > hitPos.y)
                ...
                Gizmos.DrawCube(hitPos - new Vector3(0, d / 2, 0), new Vector3(0.02f, d, 0.02f));
            var selectedInEditor = CutsceneUtility.selectedObject is CameraShot
                    && (CutsceneUtility.selectedObject as CameraShot).targetShot == this;
