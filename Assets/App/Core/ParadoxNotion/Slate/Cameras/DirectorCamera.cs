...
namespace Slate
{
    ...
    public class DirectorCamera : MonoBehaviour, IDirectableCamera
    {
        ...
        public Camera cam {
            get {
                if (_cam == null) {
                    ...
                    if (_cam == null) _cam = CreateRenderCamera();
                }
                return _cam;
            }
        }
        ...
        public float fieldOfView {
            get => cam.orthographic ? cam.orthographicSize : cam.fieldOfView;
            set {
                if (!ignoreFOVChanges) {
        ...
        public float focalDistance {
            ...
            set {
                if (postDOF != null) postDOF.focusDistance.value = value;
            }
        }
        ...
        public float focalAperture {
            ...
            set {
                renderCamera.GetComponent<UnityEngine.Rendering.HighDefinition.HDAdditionalCameraData>().physicalParameters.aperture
                        = value;
            }
        }
#elif SLATE_USE_URP
        ...
        public float focalLength {
            ...
            set {
                if (postDOF != null) postDOF.focalLength.value = value;
            }
        }
        ...
        public float focalAperture {
            ...
            set {
                if (postDOF != null) postDOF.aperture.value = value;
            }
        }
#elif SLATE_USE_POSTSTACK
        public float focalDistance {
        ...
        public static bool matchMainWhenActive {
            get => current._matchMainWhenActive;
        ...
        public static bool setMainWhenActive {
            get => current._setMainWhenActive;
        ...
        public static bool dontDestroyOnLoad {
            get => current._dontDestroyOnLoad;
        ...
        public static void Enable()
        {
            ...
            if (gameCamera != null) {
                ...
                if (matchMainWhenActive) {
                    ...
                    renderCamera.GetAddComponent<UnityEngine.Rendering.Universal.UniversalAdditionalCameraData>().renderPostProcessing
                            = true;

                    if (gameCamera.TryGetComponent<UnityEngine.Rendering.Universal.UniversalAdditionalCameraData>(out var cData)) {
                        renderCamera.GetComponent<UnityEngine.Rendering.Universal.UniversalAdditionalCameraData>().antialiasing
                                = cData.antialiasing;
                    }
#endif
                    if (ignoreFOVChanges) renderCamera.fieldOfView = tempFOV;
                }
            ...
            if (setMainWhenActive) renderCamera.gameObject.tag = "MainCamera";

            //enable
            if (autoHandleActiveState) renderCamera.gameObject.SetActive(true);
#if SLATE_USE_HDRP
            ...
            if (volume.profile == null) {
                volume.profile =
                        ScriptableObject.CreateInstance<UnityEngine.Rendering.VolumeProfile>();
            }
            ...
            if (!volume.profile.TryGet<UnityEngine.Rendering.HighDefinition.DepthOfField>(out postDOF)) {
                ...
                postDOF.focusMode =
                        new UnityEngine.Rendering.HighDefinition.DepthOfFieldModeParameter(UnityEngine.Rendering.HighDefinition.DepthOfFieldMode.UsePhysicalCamera);
            ...
            if (!volume.profile.TryGet<UnityEngine.Rendering.Universal.DepthOfField>(out postDOF)) {
                ...
                postDOF.mode =
                        new UnityEngine.Rendering.Universal.DepthOfFieldModeParameter(UnityEngine.Rendering.Universal.DepthOfFieldMode.Bokeh);
...
#elif SLATE_USE_POSTSTACK
            var volume =
                    renderCamera.GetAddComponent<UnityEngine.Rendering.PostProcessing.PostProcessVolume>();
            volume.isGlobal = true;
            volume.priority = int.MaxValue;
            ...
            if (!volume.profile.TryGetSettings<UnityEngine.Rendering.PostProcessing.DepthOfField>(out postDOF)) {
                postDOF =
                        volume.profile.AddSettings<UnityEngine.Rendering.PostProcessing.DepthOfField>();
                postDOF.focalLength.overrideState = true;
                postDOF.focusDistance.overrideState = true;
                postDOF.aperture.overrideState = true;
                postDOF.active = true;
            ...
            var layer =
                    renderCamera.GetAddComponent<UnityEngine.Rendering.PostProcessing.PostProcessLayer>();

            if (globalPostVolume != null) {
                renderCamera.gameObject.layer = globalPostVolume.gameObject.layer;
                layer.volumeLayer =
                        LayerMask.GetMask(LayerMask.LayerToName(globalPostVolume.gameObject.layer));
            }
            else {
        ...
        public static void Disable()
        {
            ...
            if (autoHandleActiveState) renderCamera.gameObject.SetActive(false);

            //reset tag
            if (setMainWhenActive) renderCamera.gameObject.tag = "Untagged";
        ...
        {
            if (source == null)
                source = gameCamera != null ? gameCamera : (IDirectableCamera)current;
            if (target == null) target = current;
            var isCut = target != lastTargetShot;
            var endPosition = weight < 1 ? Easing.Ease(
                interpolation, source.position, target.position, weight) : target.position;
            var endRotation = weight < 1 ? Easing.Ease(
                interpolation, source.rotation, target.rotation, weight) : target.rotation;
            var endFOV = weight < 1 ? Easing.Ease(
                interpolation, source.fieldOfView, target.fieldOfView, weight) : target.fieldOfView;
            var endFocalDistance = weight < 1 ? Easing.Ease(interpolation, source.focalDistance,
                        target.focalDistance, weight)
                    : target.focalDistance;
            var endFocalLength = weight < 1 ? Easing.Ease(
                interpolation, source.focalLength, target.focalLength, weight) : target.focalLength;
            var endFocalAperture = weight < 1 ? Easing.Ease(interpolation, source.focalAperture,
                        target.focalAperture, weight)
        ...
        private void OnDrawGizmos()
        {
            ...
            Gizmos.matrix = Matrix4x4.TRS(
                cam.transform.position, cam.transform.rotation, Vector3.one);
