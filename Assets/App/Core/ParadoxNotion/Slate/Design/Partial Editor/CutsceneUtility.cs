...
namespace Slate
{
    ...
    public static class CutsceneUtility
    {
        ...
        public static Cutscene cutsceneInEditor {
            get {
                var editor = ReflectionTools.GetType("CutsceneEditor")
                        .RTGetFieldOrProp("current")
                        .RTGetFieldOrPropValue(null);
                if (editor != null)
                    return editor.GetType()
                            .RTGetFieldOrProp("cutscene")
        ...
        public static IDirectable selectedObject {
            ...
            set {
                ...
                if (value != null) Selection.activeObject = value.root.context;
                _selectedObject = value;
                if (onSelectionChange != null) onSelectionChange(value);
            }
        }
        ...
        public static Type GetCopyType() => copyType;
