...
namespace Slate
{
    ...
    {
        public override float GetPropertyHeight(SerializedProperty prop, GUIContent label) => -2;
                        ...
                        if (material != null) {
                            ...
                            for (var i = 0; i < ShaderUtil.GetPropertyCount(shader); i++) {
                                ...
                                if (att.propertyType != null) {
                                    ...
                                    if (att.propertyType == typeof(Color)
                                        && type != ShaderUtil.ShaderPropertyType.Color)
                                        continue;
                                    if (att.propertyType == typeof(Texture)
                                        && type != ShaderUtil.ShaderPropertyType.TexEnv)
                                        continue;
                                    if (att.propertyType == typeof(float)
                            ...
                            prop.stringValue = EditorTools.CleanPopup(content.text,
                                prop.stringValue, options);
                            return;
                        }
                    }
                }
