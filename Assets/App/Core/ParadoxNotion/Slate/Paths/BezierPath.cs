...
namespace Slate
{
    ...
    public class BezierPath : Path
    {
        ...
        {
#if UNITY_EDITOR
            Undo.RecordObject(this, "Path Change");
#endif
            Compute();
#if UNITY_EDITOR
        ...
        private static void DrawVerticalGuide(Vector3 position)
        {
        ...
        private static void DrawPath(BezierPoint p1, BezierPoint p2, int resolution)
        {
            var limit = resolution + 1;
            float _res = resolution;
