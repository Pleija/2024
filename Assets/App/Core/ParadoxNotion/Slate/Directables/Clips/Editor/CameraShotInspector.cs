...
namespace Slate
{
    ...
    {
        private SerializedProperty blendInEffectProp;
        private SerializedProperty blendOutEffectProp;
        private SerializedProperty dynamicTargetProp;
        private SerializedProperty fadeFromColorProp;
        private SerializedProperty fadeToColorProp;
        private SerializedProperty shotControllerProp;
        private SerializedObject shotSerializedObject;
        private SerializedProperty steadyCamEffectProp;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button(action.targetShot == null ? "Select Shot Camera"
                    : "Replace Shot Camera"))
                if (action.targetShot == null
                    || EditorUtility.DisplayDialog("Replace Shot",
                        "Selecting a new target shot will reset all animation data of this clip.",
                        "OK", "Cancel"))
            ...
            if (action.targetShot != null) {
                ...
                if (action.targetShot.dynamicController.composer.trackingMode
                    == DynamicCameraController.Composer.TrackingMode.FrameComposition) {
                ...
                if (rect.Contains(e.mousePosition)) {
                    ...
                    if (e.type == EventType.MouseDrag) {
                        ...
                        if (sc != null) in2DMode = sc.in2DMode;
                ...
                if (EditorGUI.EndChangeCheck()) action.Validate();
                //
