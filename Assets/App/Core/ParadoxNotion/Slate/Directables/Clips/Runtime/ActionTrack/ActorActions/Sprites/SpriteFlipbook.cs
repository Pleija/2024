...
namespace Slate.ActionClips
{
    ...
    public class SpriteFlipbook : ActorActionClip<SpriteRenderer>
    {
        ...
        public override bool isValid => actor != null && sprites.Count > 0;
        ...
        protected override void OnUpdate(float deltaTime)
        {
            ...
            if (index < sprites.Count) actor.sprite = sprites[index];
        }

        protected override void OnExit()
        {
            if (endWithPrevious) actor.sprite = lastSprite;
        }
        ...
        protected override void OnClipGUI(Rect rect)
        {
            ...
            for (var _i = 0; _i < sprites.Count * loops; _i++) {
                ...
                if (i == 0) {
                    ...
                    Handles.DrawLine(new Vector2(posX, rect.y), new Vector2(posX, rect.yMax));
                }
            }
        }
