...
{
    [Description(
        "Animate a float Animator parameter to a value and back to previous value gradualy over a period of time.")]
    public class AnimateFloatParameter : MecanimBaseClip
    {
        ...
        {
            if (Application.isPlaying) actor.SetFloat(parameterName, lastValue);
        }
    }
}
