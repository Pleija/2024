...
namespace Slate.ActionClips
{
    [Category("Utilities"),
     ...
     Obsolete("Use the new 'Render' feature")]
    public class ScreenCapture : DirectorActionClip
    {
        ...
        public override string info => string.Format("Record\n'{0}_#0000.png'", filename);
        ...
        protected override void OnEnter()
        {
            ...
            if (!AssetDatabase.IsValidFolder("Assets/Flipbooks"))
                AssetDatabase.CreateFolder("Assets", "Flipbooks");
            lastCapturedFrame = 0;
        }
