...
namespace Slate
{
    ...
    public class PlayVideo : ActionClip, ISubClipContainable
    {
        ...
        public override string info => videoSource == VideoSource.VideoClip
                ? videoClip != null
                        ? videoClip.name
                        + videoClip.originalPath.Substring(videoClip.originalPath.Length - 4)
                        : "No Video" : videoURL;
        ...
        private VideoTrack track => (VideoTrack)parent;
        ...
        private void Enable()
        {
            ...
            if (videoSource == VideoSource.VideoClip) track.source.clip = videoClip;
            if (videoSource == VideoSource.Url) track.source.url = videoURL;
            track.source.Play();
        }
