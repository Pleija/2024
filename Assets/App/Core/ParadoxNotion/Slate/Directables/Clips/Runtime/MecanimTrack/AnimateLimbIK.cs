...
namespace Slate.ActionClips
{
    ...
    public class AnimateLimbIK : ActorActionClip<Animator>
    {
        ...
        [AnimatableParameter(link = nameof(IKTarget)), RotationHandle(nameof(targetPosition))]
        public Vector3 targetRotation {
            get => IKTarget.rotation;
            set => IKTarget.rotation = value;
        }

        public override string info => string.Format("'{0}' IK", IKGoal.ToString());
