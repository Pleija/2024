...
namespace Slate
{
    ...
    public class CameraShot : DirectorActionClip
    {
        ...
        protected override void OnUpdate(float time, float previousTime)
        {
            ...
            if (blendInEffect == BlendInEffectType.CrossDissolve
                && previousShot != null
...
#endif
                    var dissolver = previousShot.targetShot.GetRenderTexture(
                        (int)res.x, (int)res.y, CameraType.Game);
        ...
        protected override void OnSceneGUI()
        {
            ...
            if (targetShot != null
                && GUI.Button(new Rect(5, 5, 200, 20),
