...
namespace Slate
{
    ...
    public abstract class PropertiesTrack : CutsceneTrack, IKeyable
    {
        ...
        public AnimationDataCollection animationData => _animationData;
        public object animatedParametersTarget => actor;
        ...
        public override float defaultHeight => 16f;
        ...
        public override void OnTrackInfoGUI(Rect trackRect)
        {
            ...
            showCurves = EditorGUI.Foldout(foldRect, showCurves, string.Empty);
            GUI.Label(labelRect, name, Styles.leftLabel);
