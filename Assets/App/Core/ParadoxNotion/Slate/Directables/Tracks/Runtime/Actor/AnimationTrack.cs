...
namespace Slate
{
    [Description(
     ...
     Attachable(typeof(ActorGroup)), Category("Legacy"), Icon(typeof(NavMeshAgent))]
    public class AnimationTrack : CutsceneTrack
    {
        ...
        public Transform GetMixTransform()
        {
            ...
            if (o == null)
                Debug.LogWarning("Cant find transform with name '"
                    + mixTransformName
