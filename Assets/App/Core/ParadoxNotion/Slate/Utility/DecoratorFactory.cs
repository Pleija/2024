...
namespace Slate
{
    ...
    public class DecoratorAttribute : Attribute
    {
        ...
        public DecoratorAttribute(Type targetType) => this.targetType = targetType;
    }
        ...
        private static T CreateDecorator<T>(Type targetType) where T : IDecorator
        {
            ...
            if (!decoratorsTypeMap.TryGetValue(targetType, out decoratorType)) {
                ...
                for (var i = 0; i < decoratorTypes.Length; i++) {
                    ...
                    if (att.targetType.RTIsAssignableFrom(targetType)) assignableType = current;
                }
