...
namespace FlowCanvas.Nodes
{
    public static class ReflectedNodesHelper
    {
        ...
        {
            var result = new ParamDef {
                presentedInfo = info, paramMode = ParamMode.Undefined,
            };
            ...
            out ParametresDef parametres)
        {
            ...
            for (var i = 0; i <= infos.Length - 1; i++) {
                ...
                if (def.paramMode != ParamMode.Undefined) parametres.paramDefinitions.Add(def);
            }
            return true;
        }
            ...
            ref ParametresDef parametres)
        {
            ...
            for (var i = 0; i <= prms.Length - 1; i++) {
                ...
                if (parametres.instanceDef.paramMode != ParamMode.Undefined
                    ...
                    && (def.paramMode == ParamMode.In
                        || def.paramMode == ParamMode.Ref
