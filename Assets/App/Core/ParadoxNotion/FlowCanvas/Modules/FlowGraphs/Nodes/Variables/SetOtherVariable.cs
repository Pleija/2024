...
{
    [Name("Set Other Of Type"), Category("Variables/Blackboard"),
     Description(
         "Use this to set a variable value of blackboards other than the one this flowscript is using"),
    ...
    public class SetOtherVariable<T> : FlowNode
    {
        ...
        public override string name => string.Format("Variable {0} Value",
            OperationTools.GetOperationString(operation));
        ...
        private void DoSet(Blackboard bb, string name, T value)
        {
            ...
            if (operation != OperationMethod.Set) {
                if (typeof(T) == typeof(float))
                    ...
                    targetVariable.value = (T)(object)OperationTools.Operate(
                        (int)(object)targetVariable.value, (int)(object)value, operation);
        ...
        protected override void OnNodeInspectorGUI()
        {
            if (typeof(T) == typeof(float)
                ...
                operation = (OperationMethod)EditorGUILayout.EnumPopup("Operation", operation);
