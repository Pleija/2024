...
namespace FlowCanvas.Nodes
{
    ...
    public class AddComponent<T> : CallableFunctionNode<T, GameObject, bool> where T : Component
    {
        public override T Invoke(GameObject gameObject, bool tryGetExisting)
        {
            ...
            if (gameObject != null) {
                if (tryGetExisting) component = gameObject.GetComponent<T>();
    ...
    [Category("Unity"), Description("Get a component attached on an object")]
    ...
    [Category("Unity"), Description("Creates a new ScriptableObject instance")]
    ...
    [Category("Unity"), Description("Get all child transforms of specified parent")]
    public class GetChildTransforms : PureFunctionNode<IEnumerable<Transform>, Transform>
    {
        public override IEnumerable<Transform> Invoke(Transform parent) => parent.Cast<Transform>();
    }
