    ...
    public class GetVariable<T> : ParameterVariableNode
    {
        ...
        public override string name {
            get {
                ...
                return string.Format("<size={0}>{1}</size>", size.ToString(), value);
            }
        }
#endif
        ...
        {
            base.OnNodeGUI();
            if (verboseLevel != VerboseLevel.Full) return;
            GUILayout.BeginHorizontal();
            GUILayout.FlexibleSpace();
            var theValue = value.value;

            if (theValue is Object && !theValue.Equals(null)) {
                var o = (Object)(object)theValue;
                ...
                GUI.backgroundColor = ColorUtils.Grey(EditorGUIUtility.isProSkin ? 0.15f : 0.6f);
