...
namespace FlowCanvas.Nodes
{
    ...
    public class ReflectedMethodNodeWrapper : ReflectedMethodBaseNodeWrapper
    {
        ...
        {
            if (newMethod is MethodInfo) SetMethod((MethodInfo)newMethod, instance);
        }
        ...
        public override void OnPortConnected(Port port, Port otherPort)
        {
            if (method.IsGenericMethod) {
                ...
                var newMethod = TryGetNewGenericMethodForWild(
                    wildType, port.type, otherPort.type, method);
        ...
        protected override void RegisterPorts()
        {
            ...
            if (reflectedMethodNode != null) reflectedMethodNode.RegisterPorts(this, options);
        }
    }
}
