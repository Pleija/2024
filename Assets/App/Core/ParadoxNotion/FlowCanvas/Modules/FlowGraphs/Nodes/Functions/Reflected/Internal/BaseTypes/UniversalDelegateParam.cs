    ...
    public class UniversalDelegateParam<T> : UniversalDelegateParam
    {
        ...
        public override void RegisterAsInput(FlowNode node)
        {
            if (paramDef.paramMode == ParamMode.Instance
                || paramDef.paramMode == ParamMode.In
                || paramDef.paramMode == ParamMode.Ref
                || paramDef.paramMode == ParamMode.Result)
        ...
        {
            if (paramDef.paramMode == ParamMode.Instance
                || paramDef.paramMode == ParamMode.Out
                || paramDef.paramMode == ParamMode.Ref
                || paramDef.paramMode == ParamMode.Result) {
