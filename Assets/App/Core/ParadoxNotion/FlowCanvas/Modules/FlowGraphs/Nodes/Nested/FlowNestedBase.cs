...
namespace FlowCanvas.Nodes
{
            ...
            where T : Graph
    {
        ...
        protected override void RegisterPorts()
        {
            ...
            AddValueOutput("Runtime", () => currentInstance.elapsedTime);
            AddValueOutput("Result", () => endResult);
        }
        ...
        private void Start(Flow f)
        {
            ...
            this.TryStartSubGraph(targetAgent.value, result => {
                endResult = result;
                OnStop(f);
            });
            f.Call(onStart);
