...
namespace SqlCipher4Unity3D.sqlite_net_extensions.SQLiteNetExtensions.Extensions
{
    ...
    public static class ReflectionExtensions
    {
        ...
        private static PropertyInfo GetExplicitForeignKeyProperty(this Type type,
            Type destinationType) => (from property in type.GetRuntimeProperties()
        ...
        public static PropertyInfo GetInverseProperty(this Type elementType, PropertyInfo property)
        {
            ...
            if (attribute == null
                        || (attribute.InverseProperty != null
