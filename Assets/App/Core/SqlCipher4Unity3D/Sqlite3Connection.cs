    ...
    public partial class SQLiteConnection : IDisposable
    {
        ...
        void SetKey(string key)
        {
            ...
            Execute( /*"pragma key = "*/Encoding.UTF8.GetString(new byte[] {
                    0x70, 0x72, 0x61, 0x67, 0x6D, 0x61, 0x20, 0x6B, 0x65, 0x79, 0x20, 0x3D,
                    0x20,
                })
                + q);
        }
        ...
        public void SetNewKey(string key)
        {
            ...
            Execute( /* "pragma rekey = " */ Encoding.UTF8.GetString(new byte[] {
                    0x70, 0x72, 0x61, 0x67, 0x6D, 0x61, 0x20, 0x72, 0x65, 0x6B, 0x65, 0x79,
                    0x20, 0x3D,
                    0x20,
                })
                + q);
...
//@formatter:off
        ...
        */
        ...
        void MigrateTable(TableMapping map, List<ColumnInfo> existingCols)
        {
            ...
            foreach (var p in map.Columns) {
                ...
                foreach (var c in existingCols) {
                    found = (string.Compare(p.Name, c.Name, StringComparison.OrdinalIgnoreCase)
                        == 0);
                    if (found) break;
                }
        ...
        public int Update(object obj, Type objType)
        {
            ...
            if (pk == null) {
                throw new NotSupportedException("Cannot update "
                    + map.TableName
                    + ": it has no PK");
            }
        ...
        public int Delete(object objectToDelete)
        {
            ...
            if (pk == null) {
                throw new NotSupportedException("Cannot delete "
                    + map.TableName
                    + ": it has no PK");
            }
                    ...
                    if (storeDateTimeAsTicks) {
                        ...
                        SQLite3.BindText(stmt, index,
                            ((DateTime)value).ToString(dateTimeStringFormat,
                                CultureInfo.InvariantCulture), -1, NegativePointer);
                    }
                }
            ...
            if (type == SQLite3.ColType.Null) {
                ...
                if (clrType == typeof(String)) {
                    ...
                    if (_conn.StoreTimeSpanAsTicks) {
                        ...
                        if (!TimeSpan.TryParseExact(text, "c", CultureInfo.InvariantCulture,
                            TimeSpanStyles.None,
                            out resultTime)) {
                    ...
                    if (_conn.StoreDateTimeAsTicks) {
                        ...
                        if (!DateTime.TryParseExact(text, _conn.DateTimeStringFormat,
                            ...
                            _conn.DateTimeStyle, out resultDate)) {
    ...
    internal class FastColumnSetter
    {
            ...
            where ColumnMemberType : struct
        {
            var ret = CreateNullableTypedSetterDelegate(column, typeof(ObjectType),
                ...
                ((ptr, i) => getColumnValue.Invoke(ptr, i)));
