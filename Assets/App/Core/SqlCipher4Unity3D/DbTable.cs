...
{
    public class DbTable : ScriptableBase
    {
        public static readonly Dictionary<Type, DbTable> Defaults =
            new Dictionary<Type, DbTable>();
        ...
        public static string dbPath => $"{Application.persistentDataPath}/{Md5("System")}.db";
        public static string pwd => "6FA2B924-BE3E-4353-9023-F3CCEABE4A74";
        ...
        public static SQLiteConnection Connection {
            get {
                ...
                m_Connection = Application.isEditor && dev ? new SQLiteConnection(Application.dataPath+"/Editor/dev.db") : new SQLiteConnection(dbPath, pwd);

                if (Application.isEditor) {
                    m_Connection.Trace = true;
                    m_Connection.Tracer = Debug.Log;
                }
                return m_Connection;
            }
        ...
        public virtual DbTable GetSelf() => null;
    ...
    public class DbTable<T> : DbTable where T : DbTable<T>
    {
        ...
        public override DbTable GetSelf() => self;

        public static void Setup(DbTable asset, T table)
        {
            asset.isSetup = true;
                    ...
                    if (!Regex.IsMatch(x.Name, @"^[A-Z]"))
                        switch (x) {
                            case PropertyInfo { CanRead: true, CanWrite: true, } propertyInfo:
                                value = propertyInfo.GetValue(table, null) ?? propertyInfo.PropertyType.CreateInstance();
                                // if (value == null
                            ...
                            case FieldInfo fieldInfo:
                                value = fieldInfo.GetValue(table) ?? fieldInfo.FieldType.CreateInstance();
                                //
                                // if (value == null
                                //     && fieldInfo.FieldType.GetConstructor(Type.EmptyTypes) != null
