...
namespace XNodeEditor
{
    public static class NodeEditorResources
    {
        ...
        public static Texture2D dot =>
                _dot != null ? _dot : _dot = Resources.Load<Texture2D>("xnode_dot");

        public static Texture2D dotOuter => _dotOuter != null ? _dotOuter
                : _dotOuter = Resources.Load<Texture2D>("xnode_dot_outer");

        public static Texture2D nodeBody => _nodeBody != null ? _nodeBody
                : _nodeBody = Resources.Load<Texture2D>("xnode_node");

        public static Texture2D nodeHighlight => _nodeHighlight != null ? _nodeHighlight
        ...
        public static GUIStyle OutputPort => new GUIStyle(EditorStyles.label)
