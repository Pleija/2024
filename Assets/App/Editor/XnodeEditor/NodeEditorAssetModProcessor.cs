...
namespace XNodeEditor
{
    ...
    internal class NodeEditorAssetModProcessor : UnityEditor.AssetModificationProcessor
    {
        ...
        ///     https://gitlab.com/RotaryHeart-UnityShare/subassetmissingscriptdelete
        /// </summary>
        private static AssetDeleteResult OnWillDeleteAsset(string path, RemoveAssetOptions options)
        {
            ...
            if (scriptType == null
                || (scriptType != typeof(Node) && !scriptType.IsSubclassOf(typeof(Node))))
