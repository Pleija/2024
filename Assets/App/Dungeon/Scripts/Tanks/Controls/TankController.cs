...
namespace TankShooter
{
    public class TankController : MonoBehaviour
    {
        ...
        public zFrame.UI.Joystick joystick => zFrame.UI.Joystick.instance;
        ...
        void Start()
        {
            ...
            joystick.OnValueChanged.AddListener(v => {
                if (v.magnitude == 0) {
                    //Debug.Log("joystick stop".ToBlue());
                    return;
                }
 ...
 Quaternion.LookRotation(cannonDirection); //rotate cannon to touch position
        ...
        void RotateToDirection(Transform _transform, Vector3 direction, float rotationSpeed)
        {
            if (direction != Vector3.zero) {
                ...
                _transform.rotation = Quaternion.Slerp(_transform.rotation, qTo,
        ...
        public void AddDamage(int power)
        {
            ...
            if (lifes <= 0) {
                //if all lifes over - show game over message and explode tank
        ...
        void Explode()
        {
            ...
            if (GetComponent<AudioSource>() != null
                && PlayerPrefs.GetInt("sound_enabled", 1) == 1) //play explosion sound
            ...
            GameObject explosion = (GameObject)Instantiate(explosionPrefab, transform.position,
                Quaternion.identity);
            Destroy(explosion, 2);
        }
    }
