...
namespace SqlCipher4Unity3D.sqlite_net_extensions.SQLiteNetExtensions.Extensions
{
    ...
    #region Private methods
        static void InsertAllWithChildrenRecursive(this SQLiteConnection conn, IEnumerable elements,
            bool replace, bool recursive, ISet<object> objectCache = null)
        {
            ...
            var insertedElements =
                conn.InsertElements(elements, replace, objectCache).Cast<object>().ToList();
        ...
        static void InsertWithChildrenRecursive(this SQLiteConnection conn, object element, bool replace,
        ...
        static void InsertChildrenRecursive(this SQLiteConnection conn, object element, bool replace,
            bool recursive, ISet<object> objectCache = null)
        {
            if (element == null) {
                return;
        ...
        static void InsertValue(this SQLiteConnection conn, object value, bool replace, bool recursive,
        ...
        static IEnumerable InsertElements(this SQLiteConnection conn, IEnumerable elements, bool replace,
            ISet<object> objectCache)
        {
            if (elements == null) {
        ...
        static void DeleteAllRecursive(this SQLiteConnection conn, IEnumerable elements, bool recursive,
        ...
        static void DeleteValueRecursive(this SQLiteConnection conn, object value, bool recursive,
            ISet<object> objectCache)
        {
            if (value == null) {
                return;
        ...
        static void UpdateOneToManyInverseForeignKey(this SQLiteConnection conn, object element,
        ...
        static void UpdateOneToOneInverseForeignKey(this SQLiteConnection conn, object element,
            PropertyInfo relationshipProperty)
        {
            var type = element.GetType();
            EnclosedType enclosedType;
        ...
        static void UpdateManyToManyForeignKeys(this SQLiteConnection conn, object element,
            PropertyInfo relationshipProperty)
        {
            var type = element.GetType();
            EnclosedType enclosedType;
        ...
        static void DeleteAllIds(this SQLiteConnection conn, object[] primaryKeyValues, string entityName,
            string primaryKeyName)
        {
            ...
            if (primaryKeyValues.Length <= queryLimit) {
                ...
                var deleteQuery = string.Format("delete from [{0}] where [{1}] in ({2})", entityName,
                    primaryKeyName, placeholdersString);
