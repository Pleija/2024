...
namespace Royale
{
    public class HealthBar : MonoBehaviour
    {
        ...
        public void Initialise(ThinkingPlaceable p)
        {
            ...
            wholeWidget.transform.localPosition = new Vector3(0f, p.pType == Placeable.PlaceableType.Unit ? 3f : 6f,
                p.pType == Placeable.PlaceableType.Unit ? 0f
        ...
        public void SetHealth(float newHP)
        {
            ...
            var ratio = 0f;
            if (newHP > 0f) ratio = newHP / originalHP;
