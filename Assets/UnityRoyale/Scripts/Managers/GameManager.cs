...
namespace UnityRoyale
{
    public class GameManager : MonoBehaviour
    {
        ...
        private List<ThinkingPlaceable> allPlayers, allOpponents;
        //contains both Buildings and Units
        ...
        //used to force an update of all AIBrains in the Update loop
        ...
        private void Update()
        {
            ...
            for (var pN = 0; pN < allThinkingPlaceables.Count; pN++) {
                ...
                //forces the assignment of a target in the switch below
                ...
                switch (p.state) {
                    case ThinkingPlaceable.States.Idle:
                        ...
                        var targetFound = FindClosestInList(p.transform.position,
        ...
        public void UseCard(CardData cardData, Vector3 position, Placeable.Faction pFaction)
        {
            for (var pNum = 0; pNum < cardData.placeablesData.Length; pNum++) {
                ...
                var newPlaceableGO = Instantiate<GameObject>(prefabToSpawn,
                    position + cardData.relativeOffsets[pNum], rot);
        ...
        private void OnProjectileFired(ThinkingPlaceable p)
        {
            ...
            var prj = Instantiate<GameObject>(p.projectilePrefab, p.projectileSpawnPoint.position, rot)
